  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[92vh] flex items-center overflow-hidden bg-[#0D0D1A]">
        <div className="absolute inset-0 bg-cover bg-center opacity-20" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=1600&q=80')" }} aria-hidden="true" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="text-[#E8339E] text-xs font-bold tracking-[0.2em] uppercase" style={{ fontFamily: "Montserrat, sans-serif" }}>Reston, Virginia</span>
              </div>
