/* =============================================================================
   /washington-dc/capitol-hill — Capitol Hill, DC Location Page
   Design: Clinical Noir — white hero with pink gradient accents
   Target keywords: menopause doctor Capitol Hill DC, virtual hormone therapy Capitol Hill Washington DC,
   GLP-1 weight loss Capitol Hill DC, perimenopause treatment Capitol Hill, semaglutide Capitol Hill DC,
   bioidentical hormone therapy Capitol Hill DC, testosterone therapy women Capitol Hill,
   online menopause doctor Capitol Hill Washington DC
   ============================================================================= */
...
const JSONLD_LOCAL = {
  ...
  "name": "MedMethod Direct — Capitol Hill, Washington DC",
  "description": "Virtual hormone therapy, medical weight loss, and menopause clinic serving women in Capitol Hill, Washington DC. Physician-prescribed GLP-1 weight loss, HRT, BHRT, testosterone therapy — 100% virtual, licensed in DC.",
  "url": "https://medmethoddirect.com/washington-dc/capitol-hill",
  "priceRange": "$$",
  ...
  "areaServed": { "@type": "Neighborhood", "name": "Capitol Hill", "containedInPlace": { "@type": "City", "name": "Washington DC" } },
...
const JSONLD_FAQ = {
  ...
  "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "Is there a menopause doctor near Capitol Hill, DC?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. MedMethod Direct is a virtual menopause and hormone clinic licensed in Washington DC, serving women in Capitol Hill, Eastern Market, Barracks Row, and throughout the District. Dr. Jumana Al-Deek, DO, can typically see new patients within days of a free consultation." } },
    { "@type": "Question", "name": "Can I get semaglutide prescribed online near Capitol Hill, DC?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. MedMethod Direct prescribes both FDA-approved GLP-1 medications and compounded semaglutide and tirzepatide to patients in Capitol Hill and throughout DC. Labs are ordered to a LabCorp or Quest Diagnostics near you. Medications are shipped to your Capitol Hill address." } },
    { "@type": "Question", "name": "Does MedMethod Direct accept insurance?", "acceptedAnswer": { "@type": "Answer", "text": "We are a direct-care practice and do not bill insurance. Many Capitol Hill patients use FEHB HSA or FSA funds. We provide itemized receipts for potential out-of-network reimbursement." } },
  ],
};
...
const JSONLD_BREADCRUMB = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Capitol Hill", "item": "https://medmethoddirect.com/washington-dc/capitol-hill" },
  ],
};

const faqs = [
  { q: "Is there a menopause doctor near Capitol Hill, DC?", a: "Yes. MedMethod Direct is a virtual menopause and hormone clinic licensed in Washington DC, serving women in Capitol Hill, Eastern Market, Barracks Row, Navy Yard, and throughout the District. Dr. Jumana Al-Deek, DO, can typically see new patients within days of your free consultation." },
  ...
  { q: "I have FEHB coverage — can I use my HSA or FSA?", a: "Yes. Federal employees with FEHB coverage can use their HSA or FSA funds for MedMethod Direct services. We provide detailed itemized receipts that can be submitted for potential out-of-network reimbursement. We can also write prescriptions for brand-name GLP-1 medications that you can attempt to run through your FEHB pharmacy benefit." },
  { q: "Can MedMethod Direct also serve patients in nearby Maryland or Virginia?", a: "Yes. MedMethod Direct is licensed in DC, Maryland, and Virginia. Many Capitol Hill patients have family or colleagues in nearby Bethesda MD, McLean VA, or Northern Virginia — we serve the entire DC metro area under the same physician-led program." },
  ...pricingFaqs,
  { q: "Does MedMethod Direct accept insurance?", a: "MedMethod Direct is a cash-pay practice. We do not bill insurance directly. Many Capitol Hill patients use FEHB HSA or FSA funds, and we provide detailed receipts that can be submitted for potential out-of-network reimbursement." },
  { q: "How soon can I start as a patient in Capitol Hill?", a: "Most patients complete their free consultation within 24–48 hours of requesting it. Labs are typically ordered the same day. Once results are in (usually 3–5 business days), Dr. Al-Deek reviews them and your personalized protocol is ready. Most Capitol Hill patients are on their program within 1–2 weeks of their first call." },
...
const whyCards = [
  { icon: "🏛️", title: "Built for Hill Professionals", desc: "Staffers, attorneys, lobbyists, and policy professionals with demanding schedules — virtual care that fits around your calendar, not the other way around." },
  ...
  { icon: "📅", title: "Same-Week Availability", desc: "No long waits. Most Capitol Hill patients are seen within days of their free consultation and on their protocol within two weeks." },
  { icon: "🧬", title: "Lab-Driven, Not Symptom-Driven", desc: "Every protocol starts with comprehensive bloodwork ordered to a LabCorp or Quest Diagnostics near Capitol Hill or Southeast DC." },
  { icon: "💊", title: "Semaglutide, Tirzepatide & BHRT Delivered", desc: "Medications shipped directly to your Capitol Hill address. No pharmacy runs, no prior authorization battles." },
...
const testimonials = [
  { quote: "I work in policy and my schedule is not compatible with traditional medical appointments. MedMethod Direct gave me same-week availability, a 45-minute first visit, and a protocol that actually addressed why I wasn't losing weight on semaglutide. Down 20 pounds in 12 weeks. Finally.", name: "Jennifer P.", location: "Capitol Hill, DC — Eastern Market", rating: 5 },
  { quote: "I've been a federal employee for 25 years and I know how to navigate healthcare. What I couldn't find was a physician who would spend real time on my case. Dr. Al-Deek reviewed my labs personally and explained the connection between my hormones and my weight in a way no other doctor ever had.", name: "Diane R.", location: "Capitol Hill, DC — Barracks Row", rating: 5 },
  { quote: "The flexibility is what sold me. I scheduled my consultation during a lunch break, labs were ordered that afternoon, and I was on my protocol within 10 days. No commute, no waiting room. This is what healthcare should look like for working professionals.", name: "Sarah M.", location: "Capitol Hill, DC — Navy Yard", rating: 5 },
];
...
export default function LocationCapitolHill() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>Virtual Hormone, Menopause & Weight Loss Doctor in Capitol Hill, DC | MedMethod Direct</title>
        <meta name="description" content="Virtual menopause doctor and GLP-1 weight loss physician serving Capitol Hill, Washington DC. Same-week appointments. Semaglutide, tirzepatide, HRT, BHRT, testosterone therapy. No office visits required. Dr. Jumana Al-Deek, DO." />
        <link rel="canonical" href="https://medmethoddirect.com/washington-dc/capitol-hill" />
        <meta property="og:title" content="Virtual Hormone, Menopause & Weight Loss Doctor in Capitol Hill, DC | MedMethod Direct" />
        <meta property="og:description" content="Physician-led virtual clinic for women in Capitol Hill, Washington DC. Hormone therapy, GLP-1 weight loss, menopause care — all virtual, same-week availability." />
        <meta property="og:url" content="https://medmethoddirect.com/washington-dc/capitol-hill" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 mb-6 text-xs font-bold tracking-wider uppercase" style={{ background: "rgba(232,51,158,0.08)", color: "#E8339E", fontFamily: "Montserrat, sans-serif" }}>
                  ...
                  Serving Capitol Hill, Washington DC
                </div>
                <h1 className="font-black leading-[1.05] mb-5" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.9rem, 3.4vw, 3.3rem)", letterSpacing: "-0.02em", color: "#111111" }}>
                  ...
                  <br />
                  for Capitol Hill women
                </h1>
                <p className="text-base mb-6 leading-relaxed" style={{ fontFamily: "Montserrat, sans-serif", color: "#555", maxWidth: "480px" }}>
                  Physician-led virtual care for women in Capitol Hill and Washington DC. Hormone therapy, GLP-1 weight loss, and menopause care — all in one program. Fits your schedule. Same-week availability.
                </p>
              ...
              <div className="relative lg:-ml-6">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ aspectRatio: "4/3" }}>
                  <img
                    ...
                    alt="Virtual menopause and hormone therapy doctor for women in Capitol Hill, Washington DC — MedMethod Direct"
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5" style={{ background: "linear-gradient(to top, rgba(0,0,0,0.55) 0%, transparent 100%)" }}>
                    <p className="text-white font-bold text-sm tracking-wide" style={{ fontFamily: "Montserrat, sans-serif" }}>Serving Capitol Hill · Eastern Market · Barracks Row · Navy Yard · Hill East</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-[900px] mx-auto px-4 lg:px-8">
          <p className="text-xs font-bold tracking-[0.2em] uppercase text-[#E8339E] mb-3" style={{ fontFamily: "Montserrat, sans-serif" }}>SERVING CAPITOL HILL & SOUTHEAST DC</p>
          <h2 className="font-black text-[#111111] mb-6" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.2rem)", letterSpacing: "-0.02em" }}>
            A Menopause &amp; Weight Loss Physician for Capitol Hill Women — On Your Schedule
          </h2>
          <div className="text-gray-600 text-base leading-relaxed space-y-4" style={{ fontFamily: "Montserrat, sans-serif" }}>
            <p>
              If you've been searching for a <strong>menopause doctor near Capitol Hill DC</strong> or a <strong>GLP-1 weight loss physician in Washington DC</strong>, MedMethod Direct was built for you. Capitol Hill is home to policy professionals, federal staffers, attorneys, and lobbyists — people with demanding schedules and very low tolerance for healthcare that wastes their time.
            </p>
            <p>
              Led by <strong>Dr. Jumana Al-Deek, DO</strong>, MedMethod Direct offers <strong>perimenopause and menopause management</strong>, <strong>bioidentical hormone therapy (BHRT)</strong>, <strong>testosterone therapy for women</strong>, and <strong>physician-prescribed semaglutide and tirzepatide</strong> — all through a single integrated virtual program. Schedule during a lunch break. No commute. Same-week availability.
            </p>
            <p>
              Capitol Hill has a high concentration of federal employees with FEHB coverage — and while we are a cash-pay practice, many patients use their HSA or FSA funds, and we provide documentation for potential out-of-network reimbursement. We can also write prescriptions for brand-name GLP-1 medications for patients who want to attempt to use their pharmacy benefit.
            </p>
          </div>
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-3">
            {[
              ...
              "Labs ordered to LabCorp or Quest near Capitol Hill",
              "Same-week availability — fits your schedule",
      ...
      <section className="py-16 bg-[#F9F9FB]">
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <p className="text-xs font-bold tracking-[0.2em] uppercase text-[#E8339E] mb-3 text-center" style={{ fontFamily: "Montserrat, sans-serif" }}>WHY CAPITOL HILL WOMEN CHOOSE US</p>
          <h2 className="font-black text-[#111111] mb-10 text-center" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.4rem, 2.5vw, 2rem)", letterSpacing: "-0.01em" }}>
            Care That Fits a Professional's Schedule
          </h2>
        ...
        <div className="max-w-[900px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-10">
            ...
            <h2 className="font-black leading-tight" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.4rem)", color: "#111111" }}>
              Frequently Asked Questions for{" "}<span style={{background: "linear-gradient(135deg, #E8339E 0%, #7A1E7E 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent"}}>Capitol Hill Patients</span>
            </h2>
          </div>
          {/* Tab buttons */}
      ...
      <section className="py-14 bg-white">
        <div className="max-w-[860px] mx-auto px-4 lg:px-8">
          ...
          <h2 className="font-black text-[#111111] mb-8 text-center" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.2rem, 2vw, 1.6rem)" }}>
            Capitol Hill Neighbors Across the DC Metro
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { name: "Washington DC Hub", href: "/washington-dc", sub: "All DC neighborhoods" },
              { name: "Georgetown, DC", href: "/washington-dc/georgetown", sub: "Northwest DC" },
              { name: "Bethesda, Maryland", href: "/maryland/bethesda", sub: "Just across the DC line" },
            ].map((link) => (
      ...
      <section className="py-20 px-6 text-center" style={{ background: "linear-gradient(135deg, #0D0D1A 0%, #1a0a1e 100%)" }}>
        <div className="max-w-[640px] mx-auto">
          <span className="block text-xs font-extrabold tracking-[0.22em] uppercase mb-4" style={{ color: "#E8339E" }}>Capitol Hill, Washington DC</span>
          ...
          <p className="mb-8 text-sm leading-relaxed" style={{ color: "rgba(255,255,255,0.50)" }}>
            Free 20-minute consultation with a member of our clinical team. No obligation, no pressure. Schedule around your workday — morning, lunch, or evening.
          </p>
          ...
          <p className="text-white/25 text-xs mt-5">
            Serving Capitol Hill · Eastern Market · Barracks Row · Navy Yard · Hill East · and all of Washington DC
          </p>
        </div>
      </section>
