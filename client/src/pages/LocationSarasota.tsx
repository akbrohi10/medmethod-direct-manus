/* =============================================================================
   Sarasota, Florida Location Page — MedMethod Direct
   Primary keyword: menopause doctor Sarasota FL telehealth
   Secondary: hormone therapy Sarasota Florida, GLP-1 weight loss Sarasota,
   semaglutide Sarasota telehealth, virtual menopause care Sarasota FL,
   bioidentical hormone therapy Sarasota, perimenopause treatment Sarasota Florida
   ============================================================================= */
...
const JSONLD_MEDICAL_BUSINESS = {
  ...
  "name": "MedMethod Direct — Sarasota, Florida",
  "description": "Virtual hormone therapy, medical weight loss, and menopause clinic serving women in Sarasota, Florida. Physician-prescribed GLP-1 weight loss (semaglutide, tirzepatide), HRT, BHRT, testosterone therapy, perimenopause management, and longevity medicine — 100% virtual, licensed in Florida.",
  "url": "https://medmethoddirect.com/florida/sarasota",
  "telephone": "",
  "hasMap": "https://medmethoddirect.com/florida/sarasota",
  "priceRange": "$$",
...
const JSONLD_FAQ = {
  ...
  "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "Do you serve patients in Sarasota, Florida?", "acceptedAnswer": { "@type": "Answer", "text": "Yes — MedMethod Direct is fully licensed to serve patients throughout Sarasota and the surrounding area, including Bradenton, Venice, Siesta Key, and Longboat Key. All care is delivered 100% virtually, so you never need to leave Sarasota." } },
    { "@type": "Question", "name": "Can I get semaglutide or tirzepatide online in Sarasota?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. We offer access to both FDA-approved GLP-1 medications and compounded semaglutide and tirzepatide from an FDA-registered 503B outsourcing pharmacy, prescribed by Dr. Al-Deek after a thorough review of your labs and health history. Medications are shipped directly to your Sarasota address." } },
    { "@type": "Question", "name": "Why choose virtual care over a local OB/GYN in Sarasota?", "acceptedAnswer": { "@type": "Answer", "text": "Most local practices in Sarasota have 3–6 week wait times for new patients, and appointments are often limited to 10–15 minutes. With MedMethod Direct, you can be seen within days, your appointments are 30–60 minutes, and you have a dedicated wellness advisor between visits." } },
  ],
};

const localFaqs = [
  { q: "Do you serve patients in Sarasota, Florida?", a: "Yes — MedMethod Direct is fully licensed to serve patients throughout Sarasota and the surrounding area, including Bradenton, Venice, Siesta Key, and Longboat Key. All care is delivered 100% virtually, so you never need to leave Sarasota." },
...
export default function LocationSarasota() {
  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: "Montserrat, sans-serif" }}>
      <Helmet>
        <title>Virtual Hormone, Menopause & Weight Loss Doctor in Sarasota, FL | MedMethod Direct</title>
        <meta name="description" content="Expert virtual hormone therapy, GLP-1 medical weight loss & menopause care for women in Sarasota, FL. Physician-prescribed semaglutide, BHRT & testosterone. See a doctor this week — free consultation." />
        <link rel="canonical" href="https://medmethoddirect.com/florida/sarasota" />
        <meta property="og:title" content="Virtual Hormone, Menopause & Weight Loss Doctor in Sarasota, FL | MedMethod Direct" />
        <meta property="og:url" content="https://medmethoddirect.com/florida/sarasota" />
        <meta property="og:image" content={HERO_IMAGE} />
        <meta property="og:description" content="Expert virtual hormone therapy, GLP-1 medical weight loss & menopause care for women in Sarasota, FL. Physician-prescribed semaglutide, BHRT & testosterone. Free consultation." />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Virtual Hormone, Menopause & Weight Loss Doctor in Sarasota, FL | MedMethod Direct" />
        <meta name="twitter:description" content="Expert virtual hormone therapy, GLP-1 medical weight loss & menopause care for women in Sarasota, FL. Physician-prescribed semaglutide, BHRT & testosterone. Free consultation." />
        ...
        <script type="application/ld+json">{JSON.stringify(JSONLD_FAQ)}</script>
          ...
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "MedicalWebPage",
            "name": "Virtual Hormone, Menopause & Weight Loss Doctor in Sarasota, FL",
            "url": "https://medmethoddirect.com/florida/sarasota",
  "telephone": "",
  "hasMap": "https://medmethoddirect.com/florida/sarasota",
            "description": "MedMethod Direct provides physician-led virtual hormone therapy, GLP-1 medical weight loss (semaglutide, tirzepatide), menopause management, BHRT, and testosterone therapy for women in Sarasota, Florida.",
            "about": [
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
              <div>
                ...
                <p className="text-base mb-6 leading-relaxed" style={{ fontFamily: "Montserrat, sans-serif", color: "#555", maxWidth: "480px" }}>
                  The only virtual clinic combining physician-prescribed hormone therapy, GLP-1 medical weight loss, and menopause care — all in one program, for women in Sarasota and the Gulf Coast.
                </p>
                ...
                <p className="flex items-center gap-2 font-semibold mb-8" style={{ fontFamily: "Montserrat, sans-serif", color: "#7A1E7E", fontSize: "1rem" }}>
                  <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 16 16" fill="none">
                    <circle cx="8" cy="8" r="8" fill="url(#vcGradSRQ)"/>
                    <path d="M4.5 8.5l2.5 2.5 4.5-5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    <defs><linearGradient id="vcGradSRQ" x1="0" y1="0" x2="16" y2="16" gradientUnits="userSpaceOnUse"><stop stopColor="#E8339E"/><stop offset="1" stopColor="#7A1E7E"/></linearGradient></defs>
                  </svg>
              ...
              <div className="relative lg:-ml-6">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ aspectRatio: "4/3" }}>
                  <img src={HERO_IMAGE} alt="Virtual menopause and hormone therapy doctor for women in Sarasota, Florida — MedMethod Direct" className="w-full h-full object-cover" width="640" height="480" loading="eager" />
                </div>
                <div className="absolute -bottom-4 -left-4 rounded-2xl px-5 py-3 shadow-xl" style={{ background: "linear-gradient(135deg, #E8339E 0%, #7A1E7E 100%)" }}>
                  ...
                  <p className="text-white/80 text-xs mt-0.5" style={{ fontFamily: "Montserrat, sans-serif" }}>Serving Sarasota · Bradenton · Venice · Siesta Key</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-[900px] mx-auto px-4 lg:px-8">
          <p className="text-xs font-bold tracking-widest uppercase mb-3" style={{ color: "#E8339E", fontFamily: "Montserrat, sans-serif" }}>Virtual Care for Sarasota Women</p>
          <h2 className="font-black leading-tight mb-6" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.4rem)", color: "#111111" }}>
            Sarasota's premier virtual clinic for{" "}<span style={gradientText}>hormones, menopause & weight loss</span>
          </h2>
        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            ...
            >
              ...
              <span style={{...gradientText}}>Near Sarasota?</span>
              <br />
            ...
            <table className="w-full text-sm" style={{ fontFamily: "Montserrat, sans-serif" }}>
              <thead>
                <tr style={{ background: "linear-gradient(135deg, #E8339E 0%, #7A1E7E 100%)" }}>
                  ...
                  <th className="px-6 py-4 text-white font-bold text-xs tracking-wider uppercase text-center">Local OB/GYN in Sarasota</th>
              ...
              <tbody>
                {[
                  ...
                  { factor: "Commute required", local: "Yes — US-41 / I-75 traffic", mmd: "None — 100% virtual", mmdWin: true },
                  { factor: "Dedicated wellness advisor", local: "No", mmd: "Yes — between every visit", mmdWin: true },
                  { factor: "Lab work", local: "In-office only", mmd: "Local LabCorp/Quest near Sarasota", mmdWin: true },
          ...
          >
            ...
            <p className="text-sm text-center mt-3 mb-6" style={{ fontFamily: "Montserrat, sans-serif", color: "#666" }}>
              Women in Sarasota, Bradenton, and Venice are discovering that the best care isn't always the closest — it's the most attentive, the most specialized, and the most convenient for your actual life.
            </p>
...
{/* WHY SARASOTA WOMEN CHOOSE US */}
        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="font-black leading-tight" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.6rem)", color: "#111111" }}>
              Why Sarasota women choose{" "}<span style={gradientText}>MedMethod Direct</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: <Clock className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "No more 6-week waits", body: "Sarasota's top practices are booked out for months. We can see you this week — from your home, your beach house, or anywhere in the Gulf Coast area." },
              ...
              { icon: <MapPin className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Lab work near you in Sarasota", body: "We order your labs to a convenient LabCorp or Quest Diagnostics draw site near you in Sarasota or the surrounding area. Results reviewed within 48 hours." },
              { icon: <ArrowRight className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "GLP-1s + hormones delivered to your door", body: "Semaglutide, tirzepatide, BHRT, testosterone — shipped directly to your Sarasota address, discreetly and on schedule." },
            ].map((card) => (
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[800px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="font-black leading-tight" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.4rem)", color: "#111111" }}>
              Frequently asked questions for{" "}<span style={gradientText}>Sarasota patients</span>
            </h2>
          </div>
      ...
      <section className="py-20" style={{ background: "linear-gradient(135deg, #E8339E 0%, #B040B0 50%, #7A1E7E 100%)" }}>
        <div className="max-w-[700px] mx-auto px-4 text-center">
          <p className="text-xs font-bold tracking-widest uppercase mb-4 text-white/80" style={{ fontFamily: "Montserrat, sans-serif" }}>Sarasota, Florida</p>
          ...
          <p className="text-white/85 text-base leading-relaxed mb-8 max-w-xl mx-auto" style={{ fontFamily: "Montserrat, sans-serif" }}>
            Sarasota women deserve more than a rushed appointment and a prescription handed to them on the way out the door. You deserve a physician who knows your name, knows your labs, and is building a plan specifically for you. Your free consultation is 20 minutes and completely obligation-free.
          </p>
      ...
      <section className="py-14 bg-white border-t border-gray-100">
        <div className="max-w-[900px] mx-auto px-4 lg:px-8 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div>
            ...
            <h3 className="font-black text-xl mb-2" style={{ fontFamily: "Montserrat, sans-serif", color: "#0D0D1A", letterSpacing: "-0.02em" }}>Tampa, Florida — Bay Area's Largest City</h3>
            <p className="text-gray-600 text-sm leading-relaxed max-w-xl" style={{ fontFamily: "Montserrat, sans-serif" }}>
              MedMethod Direct serves patients throughout Florida's Gulf Coast. If you live or work in Tampa, St. Petersburg, or the Tampa Bay area, you can access the same physician-led hormone therapy and GLP-1 weight loss programs — 100% virtually, from home.
            </p>
          </div>
          <a href="/florida/tampa" className="inline-flex items-center gap-2 font-bold text-sm tracking-wider rounded-full px-7 py-3 whitespace-nowrap transition-all hover:shadow-lg flex-shrink-0" style={{ fontFamily: "Montserrat, sans-serif", background: "linear-gradient(135deg, #E8339E 0%, #7A1E7E 100%)", color: "#fff" }}>
            View Tampa Service Area <ArrowRight className="w-4 h-4" />
          </a>
        </div>
      </section>
