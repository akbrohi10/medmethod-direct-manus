    ...
    <>
      ...
      <section className="relative min-h-[480px] flex items-center">
        <div className="absolute inset-0">
          {/* IMAGE RULE: single physician or patient face on laptop screen only — no group Zoom calls */}
          <img src={HERO_IMAGE} alt="Telehealth menopause consultation for Falls Church VA women" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-gradient-to-r from-stone-900/80 to-stone-900/30" />
        </div>
        <div className="relative z-10 max-w-5xl mx-auto px-6 py-20">
          <p className="text-amber-400 text-sm font-semibold tracking-widest uppercase mb-3">Falls Church · City of Falls Church · Virginia</p>
          <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-4 max-w-2xl">
            Menopause Care for Falls Church, VA Women — Specialist-Level, No Wait
          </h1>
          <p className="text-stone-200 text-lg mb-8 max-w-xl">
            Falls Church is one of Northern Virginia's most affluent small cities. MedMethod Direct delivers board-certified menopause and hormone therapy via telehealth — appointments this week.
          </p>
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-stone-600 leading-relaxed mb-4">
              Falls Church is one of the wealthiest cities per capita in the United States, with a high concentration of professional women 35–65. But dedicated menopause specialists managing comprehensive HRT are concentrated in McLean or Bethesda — 15–25 minutes away with Northern Virginia traffic.
            </p>
            <p className="text-stone-600 leading-relaxed">
              MedMethod Direct brings specialist-level care to Falls Church women. Our Virginia-licensed physicians provide comprehensive menopause management and hormone therapy entirely via telehealth, with medication shipped directly to your Falls Church address.
            </p>
          </div>
      ...
      <section className="bg-stone-50 py-16 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { step: "01", title: "Lab Work", desc: "Order your comprehensive hormone panel online. Labs drawn near Falls Church — no physician referral needed." },
              ...
              { step: "03", title: "Medication Delivered", desc: "Prescriptions sent to a compounding pharmacy and shipped directly to your City of Falls Church address within days." }
            ].map(item => (
      ...
      <section className="bg-stone-800 py-16 px-6 text-center">
        ...
        <p className="text-stone-300 mb-8 max-w-xl mx-auto">Join Falls Church women who are getting specialist-level hormone care from home.</p>
        <a href={BOOK_URL} target="_blank" rel="noopener noreferrer">
