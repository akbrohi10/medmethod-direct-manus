    ...
    <>
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden bg-[#0d0d0d]">
        <div className="absolute inset-0">
          <img src={HERO_IMG} alt="Middleburg VA telehealth women's health consultation" className="w-full h-full object-cover opacity-40" />
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto px-4 lg:px-8 pt-32 pb-20">
          ...
          <p className="text-white/70 text-lg max-w-xl mb-8 leading-relaxed" style={{ fontFamily: "Montserrat, sans-serif" }}>
            Horse-country living deserves world-class health care. MedMethod Direct brings board-certified hormone therapy and menopause management to Middleburg women — entirely via secure video, with medications shipped to your estate.
          </p>
