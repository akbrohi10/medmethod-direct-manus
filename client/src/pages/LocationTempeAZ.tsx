/* =============================================================================
   LocationTempeAZ.tsx — Tempe, Arizona City Page
   medmethod-location-seo skill compliant
   Primary keyword: menopause doctor Tempe AZ
...
const faqs = [
  { q: "Is MedMethod Direct licensed to serve Tempe, Arizona patients?", a: "Yes. MedMethod Direct holds an active Arizona medical license and is fully authorized to provide telehealth services to patients in Tempe and throughout the state. Our board-certified physicians can evaluate, diagnose, and prescribe medications — including bioidentical hormones and GLP-1 weight loss therapies — through secure video consultations." },
  { q: "Do Tempe patients need to visit a clinic?", a: "No in-person visit is ever required. MedMethod Direct is a 100% virtual practice. All consultations, lab reviews, follow-ups, and prescription management happen through secure video appointments. Medications are compounded and shipped directly to your Tempe address." },
...
const JSONLD_Business = { "@context": "https://schema.org", "@type": "MedicalBusiness", name: "MedMethod Direct — Tempe", url: "https://www.medmethoddirect.com/arizona/tempe", description: "MedMethod Direct provides premium virtual women's health care in Tempe, AZ — hormone replacement therapy, GLP-1 medical weight loss, and menopause management.", medicalSpecialty: ["Endocrinology", "Obstetrics and Gynecology", "Internal Medicine"], areaServed: { "@type": "City", name: "Tempe, Arizona" }, availableService: [{ "@type": "MedicalTherapy", name: "Hormone Replacement Therapy" }, { "@type": "MedicalTherapy", name: "Medical Weight Loss" }, { "@type": "MedicalTherapy", name: "Menopause Management" }] };
...
export default function LocationTempeAZ() {
  ...
  return (
    <>
      <Helmet>
        <title>Tempe Women's Health | Hormone Therapy & Weight Loss | MedMethod Direct</title>
        <meta name="description" content="MedMethod Direct offers virtual hormone therapy, GLP-1 weight loss, and menopause care for Tempe, AZ women. Board-certified physicians, no office visit required. Book a appointment." />
        <link rel="canonical" href="https://www.medmethoddirect.com/arizona/tempe" />
        <meta property="og:title" content="Tempe Women's Health | MedMethod Direct" />
        <meta property="og:description" content="Premium virtual hormone therapy and medical weight loss for Tempe women. Board-certified physicians, 100% telehealth." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.medmethoddirect.com/arizona/tempe" />
        <meta property="og:image" content="https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/az-hero-tempe-XXVc6potJLBq7ixsy4uoSA.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Tempe Women's Health | MedMethod Direct" />
        <meta name="twitter:description" content="Premium virtual hormone therapy and medical weight loss for Tempe women." />
        <meta name="twitter:image" content="https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/az-hero-tempe-XXVc6potJLBq7ixsy4uoSA.png" />
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 lg:py-16">
            ...
            <div>
              <nav className="flex items-center gap-2 text-xs font-semibold mb-5" style={{ color: "#aaa", fontFamily: "Montserrat, sans-serif" }}>
                ...
                <span>/</span>
                <span style={{ color: "#333" }}>Tempe</span>
              </nav>
              <div
              ...
              >
                A virtual clinic combining physician-prescribed hormone therapy, GLP-1 medical weight loss, and menopause care — all in one program, for women in Tempe, AZ.
              </p>
              ...
              >
                <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 16 16" fill="none">
                  <circle cx="8" cy="8" r="8" fill="url(#vcGradTempe)"/>
                  <path d="M4.5 8.5l2.5 2.5 4.5-5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <defs><linearGradient id="vcGradTempe" x1="0" y1="0" x2="16" y2="16" gradientUnits="userSpaceOnUse"><stop stopColor="#E8339E"/><stop offset="1" stopColor="#7A1E7E"/></linearGradient></defs>
                </svg>
            ...
            <div className="relative lg:-ml-6">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ aspectRatio: "4/3" }}>
                <img
                  src="https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/az-hero-tempe-o5fWJhAzvXsxQHtXXED8dW.webp"
                  alt="Virtual menopause doctor and hormone therapy for women in Tempe, AZ — MedMethod Direct"
                ...
                >
                  <p className="text-white font-bold text-sm tracking-wide" style={{ fontFamily: "Montserrat, sans-serif" }}>
                    Serving Tempe · Scottsdale · Chandler · Mesa
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="bg-[#f9f6f1] py-20">
        <div className="max-w-[1280px] mx-auto px-4 lg:px-8 grid lg:grid-cols-2 gap-16">
          <div>
            <p className="text-[#E8339E] text-xs font-bold tracking-[0.25em] uppercase mb-4" style={{ fontFamily: "Montserrat, sans-serif" }}>Why Tempe Women Choose Us</p>
            <h2 className="text-3xl font-black text-[#0d0d0d] mb-6" style={{ fontFamily: "Montserrat, sans-serif" }}>Evidence-Based Care for<br />Tempe's Educated Women</h2>
            
          <div className="space-y-4 text-base leading-relaxed" style={{ color: "#444" }}>
            <p>
              If you live in Tempe and you've been searching for a{" "}
              <strong>menopause doctor near Tempe, AZ</strong>, a{" "}
              <strong>medical weight loss physician serving Tempe, Arizona</strong>, or a hormone specialist who treats the whole picture — you've found the right place. MedMethod Direct is a virtual women's health clinic built around one insight most practices miss: <strong>hormones and weight are the same problem</strong>. You cannot fix one without addressing the other.
            </p>
            <p>
            ...
            <p>
              ...
              <strong>perimenopause weight gain</strong>, brain fog, night sweats, low libido, or you've tried GLP-1s elsewhere and hit a plateau — the missing piece is almost always hormonal. MedMethod Direct is one of the few virtual practices in Arizona that addresses <strong>weight loss and hormone balance together</strong>, in a single physician-led program. No driving to Scottsdale or Chandler. No waiting rooms. Just one team, one plan, and results that last.
            </p>
          </div>
        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="font-black text-[#111111]" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.2rem)", letterSpacing: "-0.02em" }}>
              Built for Busy East Valley Women
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: <MapPin className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Lab Work Near Tempe", desc: "We order your labs to a convenient LabCorp or Quest draw site near Tempe. Results reviewed within 48 hours." },
              { icon: <Package className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Medications Delivered to Your Door", desc: "Semaglutide, tirzepatide, BHRT, testosterone — shipped directly to your Tempe address, discreetly and on schedule." },
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="font-black text-[#111111]" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.2rem)", letterSpacing: "-0.02em" }}>
              What Women in Arizona Are Saying
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { quote: "I'm a snowbird — winters in Scottsdale, summers up north. Most doctors can't handle that. MedMethod doesn't care where I am. Virtual visits from either state, meds shipped to whichever address I'm at, and my performance coach texts me the same time every week regardless. The consistency is what makes the results stick. Down 19 lbs across two states.", name: "Diane K.", location: "Tempe, AZ", rating: 5 },
        ...
        <div className="max-w-[900px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-10">
            ...
            <h2 className="font-black leading-tight" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.4rem)", color: "#111111" }}>
              Frequently Asked Questions for{" "}<span style={{backgroundImage: "linear-gradient(135deg, #E8339E 0%, #7A1E7E 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent"}}>Tempe Patients</span>
            </h2>
          </div>
          {/* Tab buttons */}
      ...
      <section className="bg-[#0d0d0d] py-16">
        <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
          ...
          <div className="flex flex-wrap gap-3">
            {[{ name: "Chandler", href: "/arizona/chandler" }, { name: "Gilbert", href: "/arizona/gilbert" }, { name: "Scottsdale", href: "/arizona/scottsdale" }, { name: "All Arizona Cities", href: "/arizona" }].map(({ name, href }) => (
      ...
      <section className="bg-[#0d0d0d] py-20 border-t border-white/5">
        <div className="max-w-[800px] mx-auto px-4 lg:px-8 text-center">
          ...
          <p className="text-white/60 mb-8 leading-relaxed" style={{ fontFamily: "Montserrat, sans-serif" }}>Your first consultation is free. A board-certified physician reviews your history and outlines a personalized plan — all in one 45-minute video call from your Tempe home.</p>
          <button onClick={() => setConsultOpen(true)} className="px-10 py-4 font-bold text-sm tracking-widest uppercase text-white hover:opacity-90 transition-all" style={{ fontFamily: "Montserrat, sans-serif", background: "linear-gradient(135deg, #E8339E 0%, #7A1E7E 100%)" }}>Book Your 45-Min Appointment</button>
          <p className="text-white/30 text-xs mt-4" style={{ fontFamily: "Montserrat, sans-serif" }}>Licensed in Arizona · Serving Tempe · 100% Virtual</p>
        </div>
      </section>
