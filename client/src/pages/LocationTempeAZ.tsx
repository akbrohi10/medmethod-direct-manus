  ...
  return (
    <>
      ...
      <section className="relative min-h-[92vh] flex items-center bg-[#0d0d0d] overflow-hidden pt-20">
        <div className="absolute inset-0 bg-cover bg-center opacity-30" style={{ backgroundImage: `url('https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/az-hero-tempe-o5fWJhAzvXsxQHtXXED8dW.webp')` }} />
        ...
        <div className="relative max-w-[1280px] mx-auto px-4 lg:px-8 py-24">
          <nav className="flex items-center gap-2 text-white/40 text-xs mb-6" style={{ fontFamily: "Montserrat, sans-serif" }}>
            ...
            <span className="text-white/70">Tempe</span>
          </nav>
          <p className="text-[#E8339E] text-xs font-bold tracking-[0.25em] uppercase mb-4" style={{ fontFamily: "Montserrat, sans-serif" }}>Tempe, Arizona</p>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-[1.05] mb-6 max-w-2xl" style={{ fontFamily: "Montserrat, sans-serif" }}>
            Tempe Women's<br /><span style={{ background: "linear-gradient(135deg, #E8339E 0%, #7A1E7E 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>Health & Hormones</span>
          </h1>
          <p className="text-white/70 text-lg leading-relaxed mb-8 max-w-xl" style={{ fontFamily: "Montserrat, sans-serif" }}>Expert virtual hormone therapy, GLP-1 medical weight loss, and menopause management for Tempe women. Board-certified physicians. Licensed in Arizona. No office visit required.</p>
      ...
      <section className="bg-[#f9f6f1] py-20">
        <div className="max-w-[1280px] mx-auto px-4 lg:px-8 grid lg:grid-cols-2 gap-16">
          <div>
            ...
            <p className="text-[#0d0d0d]/70 leading-relaxed mb-4" style={{ fontFamily: "Montserrat, sans-serif" }}>Tempe's proximity to Arizona State University and a growing biotech and tech corridor has created a highly educated, research-aware female demographic. Women in Tempe approach their health with the same analytical rigor they bring to their professional lives — they want evidence-based protocols, transparent lab-driven decision making, and physicians who explain the science behind their recommendations.</p>
            <p className="text-[#0d0d0d]/70 leading-relaxed" style={{ fontFamily: "Montserrat, sans-serif" }}>MedMethod Direct delivers exactly that. Our board-certified physicians build every treatment plan around comprehensive lab analysis — full hormone panels, thyroid, metabolic markers — and explain each decision in plain language. Bioidentical hormones and GLP-1 medications are compounded at FDA-registered 503B pharmacies and shipped directly to your Tempe address.</p>
          </div>
      ...
      <section className="bg-[#f9f6f1] py-20">
        <div className="max-w-[800px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-12"><p className="text-[#E8339E] text-xs font-bold tracking-[0.25em] uppercase mb-3" style={{ fontFamily: "Montserrat, sans-serif" }}>Tempe FAQ</p><h2 className="text-3xl font-black text-[#0d0d0d]" style={{ fontFamily: "Montserrat, sans-serif" }}>Common Questions</h2></div>
