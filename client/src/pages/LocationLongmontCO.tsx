  ...
  return (
    <>
      ...
      <section className="bg-stone-50 py-16 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { step: "01", title: "Lab Work", desc: "Order your comprehensive hormone panel online. Labs drawn near Longmont — no physician referral needed." },
              ...
              { step: "03", title: "Medication Delivered", desc: "Prescriptions sent to a compounding pharmacy and shipped directly to your Boulder County address within days." }
            ].map(item => (
      ...
      <section className="bg-stone-800 py-16 px-6 text-center">
        ...
        <p className="text-stone-300 mb-8 max-w-xl mx-auto">Join Longmont women who are getting specialist-level hormone care from home.</p>
