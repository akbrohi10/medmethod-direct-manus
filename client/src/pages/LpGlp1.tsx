            ...
            <div className="order-2 md:order-1 text-center md:text-left">
              ...
              <h1 className="font-['Nunito_Sans',sans-serif] text-3xl sm:text-5xl lg:text-[3.4rem] leading-[1.12] font-extrabold text-gray-900 mb-4 sm:mb-6">
                ...
                <span className="relative inline-block">
                  ...
                  {/* Brush stroke accent behind "weight loss" */}
                  <span className="absolute -bottom-1 left-0 right-0 h-4 bg-gradient-to-r from-[#E8339E]/30 to-[#7A1E7E]/20 -skew-y-1 rounded-sm" />
                </span>
                ,{" "}
