          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-10 border-2 border-gray-200 shadow-xl relative">
              ...
              <div className="mt-10 text-center">
                {/* Trust strip */}
                <div className="flex flex-col sm:flex-row sm:flex-wrap items-start sm:items-center sm:justify-center gap-2 sm:gap-x-5 sm:gap-y-2 mb-5 text-sm text-gray-600">
                  <span className="flex items-center gap-1.5">
