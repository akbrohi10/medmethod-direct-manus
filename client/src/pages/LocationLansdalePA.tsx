        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-stone-600 leading-relaxed mb-4">
              Lansdale is a growing Montgomery County community, but menopause specialists who manage bioidentical HRT, GLP-1 weight loss, and thyroid optimization are concentrated in Philadelphia or the Main Line — 30–45 minutes away with traffic.
            </p>
            <p className="text-stone-600 leading-relaxed">
              MedMethod Direct brings specialist-level care to you. Our Pennsylvania-licensed physicians provide comprehensive menopause management and hormone therapy entirely via telehealth, with medication shipped directly to your Lansdale address.
            </p>
          </div>
