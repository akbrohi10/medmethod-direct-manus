...
const HERO_IMAGE = "https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/fl-t2-vero-beach_bff7fd2e.png";
const BOOK_URL = "https://app.medmethoddirect.com/booking";

const faqs = [
  {
    "q": "Is there a menopause specialist in Vero Beach, FL?",
    "a": "Vero Beach and Indian River County have very few menopause specialists \u2014 most women drive to Palm Beach or Melbourne. MedMethod Direct provides board-certified hormone therapy via telehealth so Vero Beach women get specialist-level care without the long drive."
  },
  {
    "q": "Can I get bioidentical HRT online in Florida?",
    "a": "Yes. Florida-licensed physicians can prescribe bioidentical hormone replacement therapy via telehealth. MedMethod Direct physicians are FL-licensed and prescribe customized bioidentical estrogen, progesterone, and testosterone shipped to your Vero Beach address."
  },
  {
  ...
  {
    "q": "Do you offer GLP-1 weight loss in Vero Beach?",
    "a": "Yes. We offer semaglutide and tirzepatide programs for women throughout the Treasure Coast. Your physician evaluates your metabolic health and prescribes the appropriate GLP-1 medication shipped directly to you."
  },
  {
    "q": "Do you serve other Treasure Coast communities?",
    "a": "Yes \u2014 we serve all of the Treasure Coast including Fort Pierce, Port St. Lucie, Stuart, and Hobe Sound. Any Florida resident can schedule a telehealth appointment."
  },
  {
...
export default function LocationVeroBeachFL() {
    ...
    "@graph": [
      {
        ...
        name: "MedMethod Direct — Vero Beach, FL",
        url: "https://www.medmethoddirect.com/vero-beach-fl",
        description: "Board-certified telehealth menopause and hormone therapy for women in Vero Beach, Florida.",
        areaServed: { "@type": "City", name: "Vero Beach", containedInPlace: { "@type": "State", name: "Florida" } },
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Vero Beach", item: "https://www.medmethoddirect.com/vero-beach-fl" }
        ]
      }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        <title>Menopause Doctor Vero Beach FL | Hormone Therapy | MedMethod Direct</title>
        <meta name="description" content="Board-certified menopause and hormone therapy for women in Vero Beach, FL. Specialist-level HRT and GLP-1 weight loss via telehealth — no drive to Palm Beach." />
        <link rel="canonical" href="https://www.medmethoddirect.com/vero-beach-fl" />
        <meta property="og:title" content="Menopause Doctor Vero Beach FL | MedMethod Direct" />
        <meta property="og:description" content="Board-certified menopause and hormone therapy for women in Vero Beach, FL. Specialist-level HRT and GLP-1 weight loss via telehealth — no drive to Palm Beach." />
        <meta property="og:url" content="https://www.medmethoddirect.com/vero-beach-fl" />
      ...
      <nav className="bg-stone-50 border-b border-stone-200 py-3 px-4 text-sm text-stone-500">
        <div className="max-w-5xl mx-auto flex gap-2">
          ...
          <span>/</span>
          <span className="text-stone-800 font-medium">Vero Beach</span>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 lg:py-16">
            ...
            <div>
              <nav className="flex items-center gap-2 text-xs font-semibold mb-5" style={{ color: "#aaa", fontFamily: "Montserrat, sans-serif" }}>
                ...
                <span>/</span>
                <span style={{ color: "#333" }}>Vero Beach</span>
              </nav>
              <div
              ...
              >
                ...
                <br />
                for Vero Beach women
              </h1>
              <p
                className="text-base mb-6 leading-relaxed"
                style={{ fontFamily: "Montserrat, sans-serif", color: "#555", maxWidth: "480px" }}
              >
                The only virtual clinic combining physician-prescribed hormone therapy, GLP-1 medical weight loss, and menopause care — all in one program, for women in Vero Beach, FL.
              </p>
              ...
              >
                <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 16 16" fill="none">
                  <circle cx="8" cy="8" r="8" fill="url(#vcGradVeroBeach)"/>
                  <path d="M4.5 8.5l2.5 2.5 4.5-5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <defs><linearGradient id="vcGradVeroBeach" x1="0" y1="0" x2="16" y2="16" gradientUnits="userSpaceOnUse"><stop stopColor="#E8339E"/><stop offset="1" stopColor="#7A1E7E"/></linearGradient></defs>
                </svg>
            ...
            <div className="relative lg:-ml-6">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ aspectRatio: "4/3" }}>
                <img
                  src="https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/fl-t2-vero-beach_bff7fd2e.png"
                  alt="Virtual menopause doctor and hormone therapy for women in Vero Beach, FL — MedMethod Direct"
                ...
                >
                  <p className="text-white font-bold text-sm tracking-wide" style={{ fontFamily: "Montserrat, sans-serif" }}>
                    Serving Vero Beach · Fort Pierce · Sebastian · Palm Bay
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-4 text-base leading-relaxed" style={{ color: "#444" }}>
            ...
            <p>
              ...
              <strong>perimenopause weight gain</strong>, brain fog, night sweats, low libido, or you've tried GLP-1s elsewhere and hit a plateau — the missing piece is almost always hormonal. MedMethod Direct is one of the only virtual practices in Florida that addresses <strong>weight loss and hormone balance together</strong>, in a single physician-led program. No driving to West Palm Beach or Fort Pierce. No waiting rooms. Just one team, one plan, and results that last.
            </p>
          </div>
      ...
      {/* ── WHY VERO BEACH WOMEN CHOOSE US ── */}
        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="font-black text-[#111111]" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.2rem)", letterSpacing: "-0.02em" }}>
              Built for Busy Indian River County Women
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: <MapPin className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Lab Work Near Vero Beach", desc: "We order your labs to a convenient LabCorp or Quest draw site near Vero Beach. Results reviewed within 48 hours." },
              { icon: <Package className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Medications Delivered to Your Door", desc: "Semaglutide, tirzepatide, BHRT, testosterone — shipped directly to your Vero Beach address, discreetly and on schedule." },
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { stars: 5, quote: 'I moved to Florida for retirement and expected to enjoy it — instead I was dealing with weight gain, zero energy, and joints that ached every morning. My MedMethod physician explained that menopause had tanked my hormones and my metabolism had basically shut down. Six months later I\'ve lost 27 lbs, I\'m back on the pickleball court, and my performance coach won\'t let me skip my morning walks.', name: "Barbara J.", loc: "Vero Beach, FL" },
              { stars: 5, quote: 'I run a real estate team and I\'m on my feet showing houses all day in the Florida heat. The hot flashes on top of that were unbearable. MedMethod had me on BHRT within a week and the flashes stopped within three weeks. I also lost 15 lbs I wasn\'t even trying to lose. My clients keep asking for my secret — I just tell them to call MedMethod.', name: "Maria V.", loc: "Florida Area" },
              { stars: 5, quote: 'I\'d been bouncing between weight loss clinics for two years — Semaglutide here, B12 shots there, none of them looking at the whole picture. MedMethod was the first practice that said \'your weight and your hormones are the same problem.\' That one insight changed everything. Down 31 lbs and my performance coach keeps me accountable even when I want to cheat on vacation.', name: "Jennifer S.", loc: "Florida" },
            ].map((t, i) => (
