      ...
      <main className="overflow-x-hidden">
        ...
        <div className="[&_section]:!pt-8 [&_section]:md:!pt-12 [&_section]:lg:!pt-16">
          <MedicalTeam
            ...
            overrideBody="A 45-minute visit with Dr. Al-Deek to create a personalized hormone and/or GLP-1 treatment plan—if it's right for you. No insurance needed."
              ...
              <div className="relative pl-10 sm:pl-12 pb-8 border-l-[3px] border-[#E8339E]/25 ml-3 sm:ml-4">
                ...
                <div className="mt-3 grid sm:grid-cols-2 gap-3">
                  <div className="bg-gray-50 rounded-xl border border-gray-200 p-4">
                    <p className="text-xs font-bold uppercase tracking-wider text-gray-500 mb-1">Option 1</p>
