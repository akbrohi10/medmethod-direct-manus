...
const HERO_IMAGE = "https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/md-t2-bel-air_60fc5b4f.png";
const BOOK_URL = "https://app.medmethoddirect.com/booking";

const faqs = [
  {
    "q": "Is there a menopause specialist in Bel Air, MD?",
    "a": "Bel Air and Harford County have limited menopause specialists \u2014 most are in Baltimore or Towson. MedMethod Direct provides board-certified hormone therapy via telehealth so Bel Air women get specialist-level care without the drive."
  },
  {
    "q": "Can I get bioidentical HRT online in Maryland?",
    "a": "Yes. Maryland-licensed physicians can prescribe bioidentical hormone replacement therapy via telehealth. MedMethod Direct physicians are MD-licensed and prescribe customized bioidentical estrogen, progesterone, and testosterone shipped to your Bel Air address."
  },
  {
  ...
  {
    "q": "Do you offer GLP-1 weight loss in Bel Air?",
    "a": "Yes. We offer semaglutide and tirzepatide programs for women throughout Harford County. Your physician evaluates your metabolic health and prescribes the appropriate GLP-1 medication shipped directly to you."
  },
  {
    "q": "Do you serve other Harford County communities?",
    "a": "Yes \u2014 we serve all of Harford County including Abingdon, Edgewood, Aberdeen, and Havre de Grace. Any Maryland resident can schedule a telehealth appointment."
  },
  {
...
export default function LocationBelAirMD() {
    ...
    "@graph": [
      {
        ...
        name: "MedMethod Direct — Bel Air, MD",
        url: "https://www.medmethoddirect.com/bel-air-md",
        description: "Board-certified telehealth menopause and hormone therapy for women in Bel Air, Maryland.",
        areaServed: { "@type": "City", name: "Bel Air", containedInPlace: { "@type": "State", name: "Maryland" } },
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Bel Air", item: "https://www.medmethoddirect.com/bel-air-md" }
        ]
      }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        <title>Menopause Doctor Bel Air MD | Hormone Therapy | MedMethod Direct</title>
        <meta name="description" content="Board-certified menopause and hormone therapy for women in Bel Air, MD. Specialist-level HRT and GLP-1 weight loss via telehealth — no drive to Baltimore." />
        <link rel="canonical" href="https://www.medmethoddirect.com/bel-air-md" />
        <meta property="og:title" content="Menopause Doctor Bel Air MD | MedMethod Direct" />
        <meta property="og:description" content="Board-certified menopause and hormone therapy for women in Bel Air, MD. Specialist-level HRT and GLP-1 weight loss via telehealth — no drive to Baltimore." />
        <meta property="og:url" content="https://www.medmethoddirect.com/bel-air-md" />
      ...
      <nav className="bg-stone-50 border-b border-stone-200 py-3 px-4 text-sm text-stone-500">
        <div className="max-w-5xl mx-auto flex gap-2">
          ...
          <span>/</span>
          <span className="text-stone-800 font-medium">Bel Air</span>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 lg:py-16">
            ...
            <div>
              <nav className="flex items-center gap-2 text-xs font-semibold mb-5" style={{ color: "#aaa", fontFamily: "Montserrat, sans-serif" }}>
                ...
                <span>/</span>
                <span style={{ color: "#333" }}>Bel Air</span>
              </nav>
              <div
              ...
              >
                The only virtual clinic combining physician-prescribed hormone therapy, GLP-1 medical weight loss, and menopause care — all in one program, for women in Bel Air, MD.
              </p>
              ...
              >
                <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 16 16" fill="none">
                  <circle cx="8" cy="8" r="8" fill="url(#vcGradBelAir)"/>
                  <path d="M4.5 8.5l2.5 2.5 4.5-5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <defs><linearGradient id="vcGradBelAir" x1="0" y1="0" x2="16" y2="16" gradientUnits="userSpaceOnUse"><stop stopColor="#E8339E"/><stop offset="1" stopColor="#7A1E7E"/></linearGradient></defs>
                </svg>
            ...
            <div className="relative lg:-ml-6">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ aspectRatio: "4/3" }}>
                <img
                  src="https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/md-t2-bel-air_60fc5b4f.png"
                  alt="Virtual menopause doctor and hormone therapy for women in Bel Air, MD — MedMethod Direct"
                ...
                >
                  <p className="text-white font-bold text-sm tracking-wide" style={{ fontFamily: "Montserrat, sans-serif" }}>
                    Serving Bel Air · Fallston · Forest Hill · Abingdon
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4 text-base leading-relaxed" style={{ color: "#444" }}>
            ...
            <p>
              ...
              <strong>perimenopause weight gain</strong>, brain fog, night sweats, low libido, or you've tried GLP-1s elsewhere and hit a plateau — the missing piece is almost always hormonal. MedMethod Direct is one of the only virtual practices in Maryland that addresses <strong>weight loss and hormone balance together</strong>, in a single physician-led program. No driving to Baltimore or Towson. No waiting rooms. Just one team, one plan, and results that last.
            </p>
          </div>
        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="font-black text-[#111111]" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.2rem)", letterSpacing: "-0.02em" }}>
              Built for Busy Harford County Women
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: "🧪", title: "Lab Work Near Bel Air", desc: "We order your labs to a convenient LabCorp or Quest draw site near Bel Air. Results reviewed within 48 hours." },
              { icon: "📦", title: "Medications Delivered to Your Door", desc: "Semaglutide, tirzepatide, BHRT, testosterone — shipped directly to your Bel Air address, discreetly and on schedule." },
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { stars: 5, quote: "I finally found a doctor who listens. My energy is back, my sleep is better, and I\'ve lost 18 lbs in 3 months. I wish I\'d started sooner.", name: "Sarah M.", loc: "Bel Air, Maryland" },
              { stars: 5, quote: "The convenience of virtual visits is a game-changer. No more sitting in waiting rooms. My hormone levels are balanced for the first time in years.", name: "Jennifer L.", loc: "Bel Air Area" },
        ...
        <div className="max-w-[900px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-10">
            ...
            <h2 className="font-black leading-tight" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.4rem)", color: "#111111" }}>
              Frequently Asked Questions for{" "}<span style={{background: "linear-gradient(135deg, #E8339E 0%, #7A1E7E 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent"}}>Bel Air Patients</span>
            </h2>
          </div>
          {/* Tab buttons */}
