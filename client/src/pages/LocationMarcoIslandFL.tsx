...
const HERO_IMAGE = "https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/fl-t2-marco-island_d74fd4db.png";
const BOOK_URL = "https://app.medmethoddirect.com/booking";

const faqs = [
  {
    "q": "Is there a menopause specialist on Marco Island, FL?",
    "a": "Marco Island has limited specialist medical care \u2014 the nearest menopause physicians are in Naples. MedMethod Direct provides board-certified hormone therapy via telehealth so Marco Island women get specialist-level care without leaving the island."
  },
  {
    "q": "Can I get HRT prescribed online in Florida?",
    "a": "Yes. Florida-licensed physicians can prescribe hormone replacement therapy via telehealth. MedMethod Direct physicians are FL-licensed and can prescribe bioidentical HRT shipped to your Marco Island address."
  },
  {
    "q": "What does the $449 diagnostic setup include?",
    "a": "Your $449 onboarding includes a comprehensive hormone and metabolic lab panel, a 60-minute physician consultation, and a personalized treatment protocol. Labs can be drawn at a local facility near Marco Island."
  },
  {
    "q": "Do you offer GLP-1 weight loss on Marco Island?",
    "a": "Yes. We offer semaglutide and tirzepatide programs for women in Marco Island and throughout Collier County. Your physician evaluates your metabolic health and prescribes the appropriate GLP-1 medication shipped directly to you."
  },
  {
    "q": "Do you serve other Southwest Florida communities?",
    "a": "Yes \u2014 we serve all of Southwest Florida including Naples, Bonita Springs, Estero, Fort Myers, and Cape Coral. Any Florida resident can schedule a telehealth appointment."
  },
  {
...
export default function LocationMarcoIslandFL() {
    ...
    "@graph": [
      {
        ...
        name: "MedMethod Direct — Marco Island, FL",
        url: "https://www.medmethoddirect.com/marco-island-fl",
        description: "Board-certified telehealth menopause and hormone therapy for women in Marco Island, Florida.",
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Marco Island", item: "https://www.medmethoddirect.com/marco-island-fl" }
        ]
      }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        <title>Menopause Doctor Marco Island FL | Hormone Therapy | MedMethod Direct</title>
        <meta name="description" content="Board-certified menopause and hormone therapy for women in Marco Island, FL. Specialist-level HRT and GLP-1 weight loss via telehealth — no drive to Naples." />
        <link rel="canonical" href="https://www.medmethoddirect.com/marco-island-fl" />
        <meta property="og:title" content="Menopause Doctor Marco Island FL | MedMethod Direct" />
        <meta property="og:description" content="Board-certified menopause and hormone therapy for women in Marco Island, FL. Specialist-level HRT and GLP-1 weight loss via telehealth — no drive to Naples." />
        <meta property="og:url" content="https://www.medmethoddirect.com/marco-island-fl" />
      ...
      <nav className="bg-stone-50 border-b border-stone-200 py-3 px-4 text-sm text-stone-500">
        <div className="max-w-5xl mx-auto flex gap-2">
          ...
          <span>/</span>
          <span className="text-stone-800 font-medium">Marco Island</span>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 lg:py-16">
            ...
            <div>
              <nav className="flex items-center gap-2 text-xs font-semibold mb-5" style={{ color: "#aaa", fontFamily: "Montserrat, sans-serif" }}>
                ...
                <span>/</span>
                <span style={{ color: "#333" }}>Marco Island</span>
              </nav>
              <div
              ...
              >
                ...
                <br />
                for Marco Island women
              </h1>
              <p
                className="text-base mb-6 leading-relaxed"
                style={{ fontFamily: "Montserrat, sans-serif", color: "#555", maxWidth: "480px" }}
              >
                The only virtual clinic combining physician-prescribed hormone therapy, GLP-1 medical weight loss, and menopause care — all in one program, for women in Marco Island, FL.
              </p>
              ...
              >
                <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 16 16" fill="none">
                  <circle cx="8" cy="8" r="8" fill="url(#vcGradMarcoIsland)"/>
                  <path d="M4.5 8.5l2.5 2.5 4.5-5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <defs><linearGradient id="vcGradMarcoIsland" x1="0" y1="0" x2="16" y2="16" gradientUnits="userSpaceOnUse"><stop stopColor="#E8339E"/><stop offset="1" stopColor="#7A1E7E"/></linearGradient></defs>
                </svg>
            ...
            <div className="relative lg:-ml-6">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ aspectRatio: "4/3" }}>
                <img
                  src="https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/fl-t2-marco-island_d74fd4db.png"
                  alt="Virtual menopause doctor and hormone therapy for women in Marco Island, FL — MedMethod Direct"
                ...
                >
                  <p className="text-white font-bold text-sm tracking-wide" style={{ fontFamily: "Montserrat, sans-serif" }}>
                    Serving Marco Island · Naples · Bonita Springs · Fort Myers
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-4 text-base leading-relaxed" style={{ color: "#444" }}>
            ...
            <p>
              ...
              <strong>perimenopause weight gain</strong>, brain fog, night sweats, low libido, or you've tried GLP-1s elsewhere and hit a plateau — the missing piece is almost always hormonal. MedMethod Direct is one of the only virtual practices in Florida that addresses <strong>weight loss and hormone balance together</strong>, in a single physician-led program. No driving to Naples or Fort Myers. No waiting rooms. Just one team, one plan, and results that last.
            </p>
          </div>
      ...
      {/* ── WHY MARCO ISLAND WOMEN CHOOSE US ── */}
        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="font-black text-[#111111]" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.2rem)", letterSpacing: "-0.02em" }}>
              Built for Busy Collier County Women
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: <MapPin className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Lab Work Near Marco Island", desc: "We order your labs to a convenient LabCorp or Quest draw site near Marco Island. Results reviewed within 48 hours." },
              { icon: <Package className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Medications Delivered to Your Door", desc: "Semaglutide, tirzepatide, BHRT, testosterone — shipped directly to your Marco Island address, discreetly and on schedule." },
