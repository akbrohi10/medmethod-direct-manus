...
const HERO_IMAGE = "https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/nc-hero-charlotte-4uQSSrcPDqt3jSVvEBmG2C.webp";

const faqs = [
  {
    q: "Is MedMethod Direct licensed to practice in North Carolina?",
    a: "Yes. MedMethod Direct is fully licensed to practice medicine in North Carolina. Our board-certified physicians are authorized to evaluate, prescribe, and manage hormone therapy and medical weight loss programs for patients throughout the state — including Charlotte — entirely via telehealth, with no in-person visit required.",
  },
  {
    q: "Do I need to visit an office to become a patient in Charlotte?",
    a: "No. MedMethod Direct is a 100% virtual practice. Everything — your consultation, lab review, prescription, and ongoing check-ins — happens online via secure video. Your medication ships directly from a licensed 503B compounding pharmacy to your Charlotte address.",
  },
  {
    q: "Why do Charlotte women choose telehealth for hormone therapy?",
    a: "Charlotte's SouthPark and Myers Park corridors are home to a large population of busy professional women — many working in finance, banking, and corporate leadership — who simply don't have time to navigate long specialist wait times. MedMethod Direct fits the Charlotte lifestyle: premium care, on your schedule, without leaving home.",
  },
  {
    q: "How long does it take to get started in Charlotte?",
    a: "Most Charlotte patients complete their appointment within 24–48 hours of scheduling. After your consultation and lab work, your physician typically reviews results and issues your prescription within 3–5 business days. Medication ships directly to your Charlotte address from our 503B compounding pharmacy.",
  },
  {
    q: "What services does MedMethod Direct offer Charlotte patients?",
...
export default function LocationCharlotteNC() {
  ...
  return (
    <>
      <Helmet>
        <title>Charlotte NC Women's Health | Hormone Therapy & Weight Loss | MedMethod Direct</title>
        <meta name="description" content="Virtual hormone therapy & GLP-1 weight loss for women in Charlotte, NC. Board-certified physicians, no office visit. Serving SouthPark, Myers Park & all of Charlotte." />
        <link rel="canonical" href="https://www.medmethoddirect.com/north-carolina/charlotte" />
        <meta property="og:title" content="Charlotte NC Women's Health | MedMethod Direct" />
        <meta property="og:description" content="Virtual hormone therapy & GLP-1 weight loss for women in Charlotte, NC. Board-certified physicians, no office visit required." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.medmethoddirect.com/north-carolina/charlotte" />
        <meta property="og:image" content={HERO_IMAGE} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Charlotte NC Women's Health | MedMethod Direct" />
        <meta name="twitter:description" content="Virtual hormone therapy & GLP-1 weight loss for women in Charlotte, NC. Board-certified physicians, no office visit required." />
        <meta name="twitter:image" content={HERO_IMAGE} />
        <script type="application/ld+json">{JSON.stringify({
          "@context": "https://schema.org", "@type": "MedicalBusiness",
          "name": "MedMethod Direct", "url": "https://www.medmethoddirect.com/north-carolina/charlotte",
          "description": "MedMethod Direct provides virtual hormone therapy and GLP-1 weight loss programs for women in Charlotte, NC, including the SouthPark and Myers Park communities.",
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "Charlotte", "item": "https://www.medmethoddirect.com/north-carolina/charlotte" },
          ],
        })}</script>
      </Helmet>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 lg:py-16">
            ...
            <div>
              <nav className="flex items-center gap-2 text-xs font-semibold mb-5" style={{ color: "#aaa", fontFamily: "Montserrat, sans-serif" }}>
                ...
                <span>/</span>
                <span style={{ color: "#333" }}>Charlotte</span>
              </nav>
              <div
              ...
              >
                A virtual clinic combining physician-prescribed hormone therapy, GLP-1 medical weight loss, and menopause care — all in one program, for women in Charlotte, NC.
              </p>
              ...
              >
                <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 16 16" fill="none">
                  <circle cx="8" cy="8" r="8" fill="url(#vcGradCharlotte)"/>
                  <path d="M4.5 8.5l2.5 2.5 4.5-5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <defs><linearGradient id="vcGradCharlotte" x1="0" y1="0" x2="16" y2="16" gradientUnits="userSpaceOnUse"><stop stopColor="#E8339E"/><stop offset="1" stopColor="#7A1E7E"/></linearGradient></defs>
                </svg>
            ...
            <div className="relative lg:-ml-6">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ aspectRatio: "4/3" }}>
                <img
                  src="https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/nc-hero-charlotte-4uQSSrcPDqt3jSVvEBmG2C.webp"
                  alt="Virtual menopause doctor and hormone therapy for women in Charlotte, NC — MedMethod Direct"
                ...
                >
                  <p className="text-white font-bold text-sm tracking-wide" style={{ fontFamily: "Montserrat, sans-serif" }}>
                    Serving Charlotte · Concord · Gastonia · Rock Hill
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="font-black text-[#111111]" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.2rem)", letterSpacing: "-0.02em" }}>
              Built for Busy Mecklenburg County Women
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: <MapPin className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Lab Work Near Charlotte", desc: "We order your labs to a convenient LabCorp or Quest draw site near Charlotte. Results reviewed within 48 hours." },
              { icon: <Package className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Medications Delivered to Your Door", desc: "Semaglutide, tirzepatide, BHRT, testosterone — shipped directly to your Charlotte address, discreetly and on schedule." },
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { quote: "I'm a nurse and I see how broken the healthcare system is every day. When I started having menopause symptoms I knew I needed someone who would actually take time with me. My MedMethod consultation was thorough, my labs were comprehensive, and my treatment plan made sense. My performance coach checks in weekly and adjusts my plan based on how I'm actually feeling — not just numbers on a chart.", name: "Tammy R.", location: "Charlotte, NC", rating: 5 },
              { quote: "I gained 45 pounds in two years and my confidence was destroyed. I stopped going to the pool, stopped wearing anything sleeveless, stopped wanting to be in photos with my grandkids. MedMethod's combined approach — hormones plus GLP-1 plus nutrition coaching — has taken 32 lbs off in 5 months. I bought a swimsuit last week for the first time in three years.", name: "Donna C.", location: "North Carolina Area", rating: 5 },
              { quote: "The accountability from my performance coach literally saved my program. Month three I was ready to quit — the scale wasn't moving, I was frustrated, and I started skipping my meds. She called me, walked me through why plateaus happen, adjusted my protocol with the doctor, and two weeks later the weight started dropping again. I would have given up without that support.", name: "Crystal B.", location: "North Carolina Patient", rating: 5 },
].map((t) => (
        ...
        <div className="max-w-[900px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-10">
            ...
            <h2 className="font-black leading-tight" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.4rem)", color: "#111111" }}>
              Frequently Asked Questions for{" "}<span style={{backgroundImage: "linear-gradient(135deg, #E8339E 0%, #7A1E7E 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent"}}>Charlotte Patients</span>
            </h2>
          </div>
          {/* Tab buttons */}
      ...
      <section className="py-12 px-6" style={{ background: "#F4F4F8" }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[{ name: "Raleigh", slug: "raleigh" }, { name: "Cary", slug: "cary" }, { name: "Chapel Hill", slug: "chapel-hill" }].map(c => (
      ...
      <section className="py-20 px-6 text-center" style={{ background: "#0d0d0d" }}>
        ...
        <h2 className="font-black text-3xl mb-4 text-white" style={{ letterSpacing: "-0.02em" }}>Ready to Start in Charlotte?</h2>
