      ...
      <section className="bg-[#f9f6f1] py-20">
        <div className="max-w-[1280px] mx-auto px-4 lg:px-8 grid lg:grid-cols-2 gap-16">
          <div>
            ...
            <p className="text-[#0d0d0d]/70 leading-relaxed mb-4" style={{ fontFamily: "Montserrat, sans-serif" }}>Gilbert has transformed from a small agricultural town into one of Arizona's most desirable suburbs, attracting health-conscious families and professionals who prioritize active, wellness-forward lifestyles. The town's strong community culture and high median income ($110k+) reflect a population that invests in preventive health — but often struggles to access specialist care in a timely manner.</p>
            <p className="text-[#0d0d0d]/70 leading-relaxed" style={{ fontFamily: "Montserrat, sans-serif" }}>MedMethod Direct's virtual model eliminates the wait. Our board-certified physicians specialize in bioidentical hormone replacement therapy, GLP-1 medical weight loss, and comprehensive menopause management — all delivered through secure video consultations on your schedule, with medications shipped directly to your Gilbert home.</p>
          </div>
