...
const whyCards = [
  { icon: "🌿", title: "Built for Health-Conscious DC Women", desc: "Dupont Circle women are progressive, informed, and health-conscious. MedMethod Direct offers integrative hormone care that matches that standard — evidence-based, lab-driven, and physician-led." },
  ...
  { icon: "📅", title: "Same-Week Availability", desc: "No long waits. Most Dupont Circle patients are seen within days of their free consultation and on their protocol within two weeks." },
  { icon: "🧬", title: "Lab-Driven, Not Symptom-Driven", desc: "Every protocol starts with comprehensive bloodwork ordered to a LabCorp or Quest Diagnostics near Dupont Circle or Northwest DC." },
  { icon: "💊", title: "Semaglutide, Tirzepatide & BHRT Delivered", desc: "Medications shipped directly to your Dupont Circle address. No pharmacy runs, no prior authorization battles." },
