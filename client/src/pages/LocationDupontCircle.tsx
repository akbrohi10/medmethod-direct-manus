    ...
    <div className="min-h-screen bg-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
              ...
              <div className="relative lg:-ml-6">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ aspectRatio: "4/3" }}>
                  <img
                    src="https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/telehealth-hero-single-face-v1-9HLiB2Wm7PXyBXDRhSWpMU.webp"
      ...
      <section className="py-16 bg-[#F9F9FB]">
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <p className="text-xs font-bold tracking-[0.2em] uppercase text-[#E8339E] mb-3 text-center" style={{ fontFamily: "Montserrat, sans-serif" }}>WHY DUPONT CIRCLE WOMEN CHOOSE US</p>
          <h2 className="font-black text-[#111111] mb-10 text-center" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.4rem, 2.5vw, 2rem)" }}>
            Integrative Care for the Health-Conscious DC Woman
          </h2>
