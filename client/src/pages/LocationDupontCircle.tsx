/* =============================================================================
   /washington-dc/dupont-circle — Dupont Circle, DC Location Page
...
import { ArrowRight, Calendar, CheckCircle2, ChevronDown, ChevronUp, FlaskConical, Leaf, MapPin, Microscope, Pill, Star, UserCheck } from "lucide-react";
...
const JSONLD_FAQ = {
  ...
  "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "Is there a menopause doctor near Dupont Circle, DC?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. MedMethod Direct is a virtual menopause and hormone clinic licensed in Washington DC, serving women in Dupont Circle, Logan Circle, Adams Morgan, Kalorama, and throughout the District. Dr. Jumana Al-Deek, DO, can typically see new patients within days of your free consultation." } },
    { "@type": "Question", "name": "Can I get semaglutide or tirzepatide prescribed online near Dupont Circle, DC?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Dr. Al-Deek prescribes both FDA-approved GLP-1 medications (Ozempic®, Wegovy®, Mounjaro®, Zepbound®) and compounded semaglutide and tirzepatide to patients in Dupont Circle and throughout DC. Labs are ordered to a LabCorp or Quest Diagnostics near you. Medications are shipped directly to your door." } },
    { "@type": "Question", "name": "Do I need to come in for bloodwork near Dupont Circle?", "acceptedAnswer": { "@type": "Answer", "text": "No office visit to MedMethod Direct is ever required. There are LabCorp and Quest Diagnostics locations throughout Northwest DC, including near Dupont Circle and Logan Circle. We order your labs, you go in for the draw, and results come directly to Dr. Al-Deek." } },
    { "@type": "Question", "name": "How is MedMethod Direct different from local practices near Dupont Circle?", "acceptedAnswer": { "@type": "Answer", "text": "Dupont Circle is one of DC's most health-conscious neighborhoods — but even the best local practices can't offer same-week availability, 30–60 minute appointments, and a program that treats hormones and GLP-1 weight loss as a single clinical problem. MedMethod Direct does all three, virtually, without the commute." } },
...
const JSONLD_BREADCRUMB = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Dupont Circle", "item": "https://medmethoddirect.com/washington-dc/dupont-circle" },
  ],
};

const faqs = [
  { q: "Is there a menopause doctor near Dupont Circle, DC?", a: "Yes. MedMethod Direct is a virtual menopause and hormone clinic licensed in Washington DC, serving women in Dupont Circle, Logan Circle, Adams Morgan, Kalorama, and throughout the District. Dr. Jumana Al-Deek, DO, can typically see new patients within days of your free consultation." },
  { q: "Can I get semaglutide or tirzepatide prescribed online near Dupont Circle, DC?", a: "Yes. Dr. Al-Deek prescribes both FDA-approved GLP-1 medications (Ozempic®, Wegovy®, Mounjaro®, Zepbound®) and compounded semaglutide and tirzepatide to patients in Dupont Circle and throughout DC. Labs are ordered to a LabCorp or Quest Diagnostics near you. Medications are shipped directly to your door." },
...
const whyCards = [
  { icon: <Leaf className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Built for Health-Conscious DC Women", desc: "Dupont Circle women are progressive, informed, and health-conscious. MedMethod Direct offers integrative hormone care that matches that standard — evidence-based, lab-driven, and physician-led." },
  ...
  { icon: <Calendar className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Same-Week Availability", desc: "No long waits. Most Dupont Circle patients are seen within days of their free consultation and on their protocol within two weeks." },
  { icon: <FlaskConical className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Lab-Driven, Not Symptom-Driven", desc: "Every protocol starts with comprehensive bloodwork ordered to a LabCorp or Quest Diagnostics near Dupont Circle or Northwest DC." },
  { icon: <Pill className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Semaglutide, Tirzepatide & BHRT Delivered", desc: "Medications shipped directly to your Dupont Circle address. No pharmacy runs, no prior authorization battles." },
...
const testimonials = [
  ...
  { quote: "I\'m a lobbyist on the Hill and appearances matter in my world — I know that sounds shallow but it\'s the reality. I gained 30 pounds during perimenopause and nothing I did at the gym was working. MedMethod\'s combined hormone and GLP-1 approach got me results in weeks, not months. My performance coach keeps me honest about nutrition and sleep even when work gets insane. Down 26 lbs.", name: "Victoria L.", location: "DC Metro", rating: 5 },
];
...
export default function LocationDupontCircle() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        ...
        <meta property="og:url" content="https://medmethoddirect.com/washington-dc/dupont-circle" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 mb-6 text-xs font-bold tracking-wider uppercase" style={{ background: "rgba(232,51,158,0.08)", color: "#E8339E", fontFamily: "Montserrat, sans-serif" }}>
                  ...
                  Serving Dupont Circle, Washington DC
                </div>
                <h1 className="font-black leading-[1.05] mb-5" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.9rem, 3.4vw, 3.3rem)", letterSpacing: "-0.02em", color: "#111111" }}>
                  ...
                  <br />
                  for Dupont Circle women
                </h1>
                <p className="text-base mb-6 leading-relaxed" style={{ fontFamily: "Montserrat, sans-serif", color: "#555", maxWidth: "480px" }}>
                  Physician-led virtual care for women in Dupont Circle and Northwest DC. Hormone therapy, GLP-1 weight loss, and menopause care — all in one integrated program. No commute. Same-week availability.
                </p>
              ...
              <div className="relative lg:-ml-6">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ aspectRatio: "4/3" }}>
                  <img
                    ...
                    alt="Virtual menopause and hormone therapy doctor for women in Dupont Circle, Washington DC — MedMethod Direct"
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5" style={{ background: "linear-gradient(to top, rgba(0,0,0,0.55) 0%, transparent 100%)" }}>
                    <p className="text-white font-bold text-sm tracking-wide" style={{ fontFamily: "Montserrat, sans-serif" }}>Serving Dupont Circle · Logan Circle · Adams Morgan · Kalorama · 14th Street Corridor</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-[900px] mx-auto px-4 lg:px-8">
          <p className="text-xs font-bold tracking-[0.2em] uppercase text-[#E8339E] mb-3" style={{ fontFamily: "Montserrat, sans-serif" }}>SERVING DUPONT CIRCLE & NORTHWEST DC</p>
          <h2 className="font-black text-[#111111] mb-6" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.2rem)", letterSpacing: "-0.02em" }}>
            A Menopause &amp; Weight Loss Physician for Dupont Circle Women
          </h2>
      ...
      <section className="py-20 bg-[#F8F4F9]">
        <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-[#E8339E] text-xs font-bold tracking-[0.2em] uppercase mb-3" style={{ fontFamily: "Montserrat, sans-serif" }}>WHY DUPONT CIRCLE WOMEN CHOOSE US</p>
            <h2 className="font-black text-[#111111]" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.2rem)", letterSpacing: "-0.02em" }}>Integrative Care for the Health-Conscious DC Woman</h2>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          ...
          <h2 className="font-black text-[#111111] mb-10 text-center" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.4rem, 2.5vw, 2rem)" }}>What Dupont Circle Women Are Saying</h2>
        ...
        <div className="max-w-[900px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-10">
            ...
            <h2 className="font-black leading-tight" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.4rem)", color: "#111111" }}>
              Frequently Asked Questions for{" "}<span style={{backgroundImage: "linear-gradient(135deg, #E8339E 0%, #7A1E7E 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent"}}>Dupont Circle Patients</span>
            </h2>
          </div>
          {/* Tab buttons */}
          ...
          <div className="min-h-[200px]">
            ...
            {activeFaqCategory.questions.filter((f): f is {q:string;a:string} => !!f).map((faq) => (
      ...
      <section className="py-14 bg-white">
        <div className="max-w-[860px] mx-auto px-4 lg:px-8">
          ...
          <h2 className="font-black text-[#111111] mb-8 text-center" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.2rem, 2vw, 1.6rem)" }}>
            Dupont Circle Neighbors Across the DC Metro
          </h2>
      ...
      <section className="py-20 px-6 text-center" style={{ background: "linear-gradient(135deg, #0D0D1A 0%, #1a0a1e 100%)" }}>
        <div className="max-w-[640px] mx-auto">
          <span className="block text-xs font-extrabold tracking-[0.22em] uppercase mb-4" style={{ color: "#E8339E" }}>Dupont Circle, Washington DC</span>
          ...
          <p className="mb-8 text-sm leading-relaxed" style={{ color: "rgba(255,255,255,0.50)" }}>
            Free 20-minute consultation with a member of our clinical team. No obligation, no pressure. Available to all Dupont Circle and Washington DC residents.
          </p>
          ...
          <p className="text-white/25 text-xs mt-5">
            Serving Dupont Circle · Logan Circle · Adams Morgan · Kalorama · 14th Street Corridor · and all of Washington DC
          </p>
        </div>
      </section>
