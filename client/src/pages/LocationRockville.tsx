...
const whyCards = [
  { icon: <Building2 className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Rockville's Largest Population Center", desc: "Rockville is the largest city in Montgomery County — and GLP-1 search growth here is among the strongest in Maryland. MedMethod Direct is positioned to serve this demand virtually, same week." },
  ...
  { icon: <Calendar className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Same-Week Availability", desc: "No long waits. Most Rockville patients are seen within days of their appointment and on their protocol within two weeks." },
  { icon: <FlaskConical className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Lab-Driven, Not Symptom-Driven", desc: "Every protocol starts with comprehensive bloodwork ordered to a LabCorp or Quest Diagnostics near Rockville — excellent lab density throughout the city." },
  { icon: <Pill className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Semaglutide, Tirzepatide & BHRT Delivered", desc: "Medications shipped directly to your Rockville address. No pharmacy runs, no prior authorization battles." },
        ...
        <div className="max-w-[900px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-10">
            ...
            <h2 className="font-black leading-tight" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.4rem)", color: "#111111" }}>
              Frequently Asked Questions for{" "}<span style={{backgroundImage: "linear-gradient(135deg, #E8339E 0%, #7A1E7E 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent"}}>Rockville Patients</span>
            </h2>
          </div>
          {/* Tab buttons */}
