...
const HERO_IMAGE = "https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/az-t2-surprise_880f1690.png";
const BOOK_URL = "https://app.medmethoddirect.com/booking";

const faqs = [
  {
    "q": "Is there a menopause specialist in Surprise, AZ?",
    "a": "Surprise and the West Valley have limited menopause specialists \u2014 most are in Scottsdale or central Phoenix. MedMethod Direct provides board-certified hormone therapy via telehealth so Surprise women get specialist-level care without the drive."
  },
  {
    "q": "Can I get HRT prescribed online in Arizona?",
    "a": "Yes. Arizona-licensed physicians can prescribe hormone replacement therapy via telehealth. MedMethod Direct physicians are AZ-licensed and can prescribe bioidentical HRT shipped to your Surprise address."
  },
  {
  ...
  {
    "q": "Do you offer GLP-1 weight loss in Surprise?",
    "a": "Yes. We offer semaglutide and tirzepatide programs for women throughout the West Valley. Your physician evaluates your metabolic health and prescribes the appropriate GLP-1 medication shipped directly to you."
  },
  {
    "q": "Do you serve other West Valley communities near Surprise?",
    "a": "Yes \u2014 we serve all of the West Valley including Peoria, Glendale, Goodyear, Avondale, and Buckeye. Any Arizona resident can schedule a telehealth appointment."
  },
  {
...
export default function LocationSurpriseAZ() {
    ...
    "@graph": [
      {
        ...
        name: "MedMethod Direct — Surprise, AZ",
        url: "https://www.medmethoddirect.com/surprise-az",
        description: "Board-certified telehealth menopause and hormone therapy for women in Surprise, Arizona.",
        areaServed: { "@type": "City", name: "Surprise", containedInPlace: { "@type": "State", name: "Arizona" } },
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Surprise", item: "https://www.medmethoddirect.com/surprise-az" }
        ]
      }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        <title>Menopause Doctor Surprise AZ | Hormone Therapy | MedMethod Direct</title>
        <meta name="description" content="Board-certified menopause and hormone therapy for women in Surprise, AZ. Specialist-level HRT and GLP-1 weight loss via telehealth — no drive to Scottsdale." />
        <link rel="canonical" href="https://www.medmethoddirect.com/surprise-az" />
        <meta property="og:title" content="Menopause Doctor Surprise AZ | MedMethod Direct" />
        <meta property="og:description" content="Board-certified menopause and hormone therapy for women in Surprise, AZ. Specialist-level HRT and GLP-1 weight loss via telehealth — no drive to Scottsdale." />
        <meta property="og:url" content="https://www.medmethoddirect.com/surprise-az" />
      ...
      <nav className="bg-stone-50 border-b border-stone-200 py-3 px-4 text-sm text-stone-500">
        <div className="max-w-5xl mx-auto flex gap-2">
          ...
          <span>/</span>
          <span className="text-stone-800 font-medium">Surprise</span>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 lg:py-16">
            ...
            <div>
              <nav className="flex items-center gap-2 text-xs font-semibold mb-5" style={{ color: "#aaa", fontFamily: "Montserrat, sans-serif" }}>
                ...
                <span>/</span>
                <span style={{ color: "#333" }}>Surprise</span>
              </nav>
              <div
              ...
              >
                The only virtual clinic combining physician-prescribed hormone therapy, GLP-1 medical weight loss, and menopause care — all in one program, for women in Surprise, AZ.
              </p>
              ...
              >
                <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 16 16" fill="none">
                  <circle cx="8" cy="8" r="8" fill="url(#vcGradSurprise)"/>
                  <path d="M4.5 8.5l2.5 2.5 4.5-5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <defs><linearGradient id="vcGradSurprise" x1="0" y1="0" x2="16" y2="16" gradientUnits="userSpaceOnUse"><stop stopColor="#E8339E"/><stop offset="1" stopColor="#7A1E7E"/></linearGradient></defs>
                </svg>
            ...
            <div className="relative lg:-ml-6">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ aspectRatio: "4/3" }}>
                <img
                  src="https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/az-t2-surprise_880f1690.png"
                  alt="Virtual menopause doctor and hormone therapy for women in Surprise, AZ — MedMethod Direct"
                ...
                >
                  <p className="text-white font-bold text-sm tracking-wide" style={{ fontFamily: "Montserrat, sans-serif" }}>
                    Serving Surprise · Peoria · Glendale · Goodyear
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-4 text-base leading-relaxed" style={{ color: "#444" }}>
            ...
            <p>
              ...
              <strong>perimenopause weight gain</strong>, brain fog, night sweats, low libido, or you've tried GLP-1s elsewhere and hit a plateau — the missing piece is almost always hormonal. MedMethod Direct is one of the only virtual practices in Arizona that addresses <strong>weight loss and hormone balance together</strong>, in a single physician-led program. No driving to Glendale or Peoria. No waiting rooms. Just one team, one plan, and results that last.
            </p>
          </div>
        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="font-black text-[#111111]" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.2rem)", letterSpacing: "-0.02em" }}>
              Built for Busy West Valley Women
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: <MapPin className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Lab Work Near Surprise", desc: "We order your labs to a convenient LabCorp or Quest draw site near Surprise. Results reviewed within 48 hours." },
              { icon: <Package className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Medications Delivered to Your Door", desc: "Semaglutide, tirzepatide, BHRT, testosterone — shipped directly to your Surprise address, discreetly and on schedule." },
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { stars: 5, quote: 'At 46 I was in full perimenopause and gaining weight so fast it scared me. I\'m a fitness instructor — this is my livelihood. MedMethod\'s approach of treating hormones and weight together was exactly right. The GLP-1 handled the appetite and the BHRT handled everything else. My performance coach helped me adjust my training around my cycle. I\'m down 25 lbs and teaching more classes than ever.', name: "Tiffany L.", loc: "Surprise, AZ" },
              { stars: 5, quote: 'I was ready to give up. Two years of hot flashes, 30 lbs gained, terrible sleep, and a libido that completely disappeared. My marriage was suffering. MedMethod addressed every single one of those issues with a coordinated plan — not five different specialists who don\'t talk to each other. One team, one plan, real results. My only regret is not starting sooner.', name: "Rebecca A.", loc: "Arizona Area" },
              { stars: 5, quote: 'I moved to Arizona for the dry heat thinking it would help my joint pain — it didn\'t, because the real issue was hormonal. MedMethod figured that out in my first consultation. Optimizing my estrogen and testosterone reduced the inflammation more than any supplement ever did. I\'ve also lost 23 lbs and my performance coach keeps me moving even when it\'s 115 degrees outside.', name: "Susan M.", loc: "Arizona" },
            ].map((t, i) => (
