  ...
  return (
    <>
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto px-4 lg:px-8 w-full">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 lg:py-16">
            ...
            <div>
              ...
              >
                The only virtual clinic combining physician-prescribed hormone therapy, GLP-1 medical weight loss, and menopause care — all in one program, for women in West Chester, PA.
              </p>
        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: "🧪", title: "Lab Work Near West Chester", desc: "We order your labs to a convenient LabCorp or Quest draw site near West Chester. Results reviewed within 48 hours." },
              { icon: "📦", title: "Medications Delivered to Your Door", desc: "Semaglutide, tirzepatide, BHRT, testosterone — shipped directly to your West Chester address, discreetly and on schedule." },
      ...
      <section className="bg-stone-50 py-16 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { step: "01", title: "Lab Work", desc: "Order your comprehensive hormone panel online. Labs drawn near West Chester — no physician referral needed." },
      ...
      <section className="bg-stone-800 py-16 px-6 text-center">
        ...
        <p className="text-stone-300 mb-8 max-w-xl mx-auto">Join West Chester women who are getting specialist-level hormone care from home.</p>
