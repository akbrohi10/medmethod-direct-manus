...
const HERO_IMAGE = "https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/pa-t2-west-chester_afb170be.png";
const BOOK_URL = "https://app.medmethoddirect.com/booking";

const faqs = [
  {
    "q": "Is there a menopause specialist in West Chester, PA?",
    "a": "West Chester has general OB-GYN practices, but dedicated menopause specialists managing bioidentical HRT are uncommon. MedMethod Direct provides board-certified hormone therapy via telehealth, so Chester County women get specialist-level care without long wait times."
  },
  {
    "q": "Can I get HRT prescribed online in Pennsylvania?",
    "a": "Yes. Pennsylvania-licensed physicians can prescribe hormone replacement therapy via telehealth after a proper medical evaluation. MedMethod Direct physicians are PA-licensed and can prescribe bioidentical estrogen, progesterone, and testosterone therapy shipped to your West Chester address."
  },
  {
    "q": "What does the $449 diagnostic setup include?",
    "a": "Your $449 onboarding includes a comprehensive hormone and metabolic lab panel, a 60-minute physician consultation to review your results, and a personalized treatment protocol. Most patients have their first prescription within 5\u20137 days of labs."
  },
  {
    "q": "Do you offer GLP-1 weight loss programs in West Chester?",
    "a": "Yes. We offer semaglutide and tirzepatide programs for women in West Chester and throughout Chester County. Your physician evaluates your metabolic health and prescribes the appropriate GLP-1 medication, shipped directly to you."
  },
  {
    "q": "Do you serve other Chester County communities?",
    "a": "Yes \u2014 we serve all of Chester County including Kennett Square, Malvern, Newtown Square, Downingtown, Coatesville, and Phoenixville. Any Pennsylvania resident can schedule a telehealth appointment."
  },
  {
...
export default function LocationWestChesterPA() {
    ...
    "@graph": [
      {
        ...
        name: "MedMethod Direct — West Chester, PA",
        url: "https://www.medmethoddirect.com/west-chester-pa",
        description: "Board-certified telehealth menopause and hormone therapy for women in West Chester, Pennsylvania.",
        areaServed: { "@type": "City", name: "West Chester", containedInPlace: { "@type": "State", name: "Pennsylvania" } },
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "West Chester", item: "https://www.medmethoddirect.com/west-chester-pa" }
        ]
      }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        <title>Menopause Doctor West Chester PA | Hormone Therapy | MedMethod Direct</title>
        <meta name="description" content="Board-certified menopause and hormone therapy for women in West Chester, PA. Specialist-level HRT and GLP-1 weight loss via telehealth — appointments this week." />
        <link rel="canonical" href="https://www.medmethoddirect.com/west-chester-pa" />
        <meta property="og:title" content="Menopause Doctor West Chester PA | MedMethod Direct" />
        <meta property="og:description" content="Board-certified menopause and hormone therapy for women in West Chester, PA. Specialist-level HRT and GLP-1 weight loss via telehealth — appointments this week." />
        <meta property="og:url" content="https://www.medmethoddirect.com/west-chester-pa" />
      ...
      <nav className="bg-stone-50 border-b border-stone-200 py-3 px-4 text-sm text-stone-500">
        <div className="max-w-5xl mx-auto flex gap-2">
          ...
          <span>/</span>
          <span className="text-stone-800 font-medium">West Chester</span>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 lg:py-16">
            ...
            <div>
              <nav className="flex items-center gap-2 text-xs font-semibold mb-5" style={{ color: "#aaa", fontFamily: "Montserrat, sans-serif" }}>
                ...
                <span>/</span>
                <span style={{ color: "#333" }}>West Chester</span>
              </nav>
              <div
              ...
              >
                ...
                <br />
                for West Chester women
              </h1>
              <p
                className="text-base mb-6 leading-relaxed"
                style={{ fontFamily: "Montserrat, sans-serif", color: "#555", maxWidth: "480px" }}
              >
                A virtual clinic combining physician-prescribed hormone therapy, GLP-1 medical weight loss, and menopause care — all in one program, for women in West Chester, PA.
              </p>
              ...
              >
                <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 16 16" fill="none">
                  <circle cx="8" cy="8" r="8" fill="url(#vcGradWestChester)"/>
                  <path d="M4.5 8.5l2.5 2.5 4.5-5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <defs><linearGradient id="vcGradWestChester" x1="0" y1="0" x2="16" y2="16" gradientUnits="userSpaceOnUse"><stop stopColor="#E8339E"/><stop offset="1" stopColor="#7A1E7E"/></linearGradient></defs>
                </svg>
            ...
            <div className="relative lg:-ml-6">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ aspectRatio: "4/3" }}>
                <img
                  src="https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/pa-t2-west-chester_afb170be.png"
                  alt="Virtual menopause doctor and hormone therapy for women in West Chester, PA — MedMethod Direct"
                ...
                >
                  <p className="text-white font-bold text-sm tracking-wide" style={{ fontFamily: "Montserrat, sans-serif" }}>
                    Serving West Chester · Exton · Malvern · Downingtown
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* ── WHY WEST CHESTER WOMEN CHOOSE US ── */}
        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="font-black text-[#111111]" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.2rem)", letterSpacing: "-0.02em" }}>
              Built for Busy Chester County Women
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: <MapPin className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Lab Work Near West Chester", desc: "We order your labs to a convenient LabCorp or Quest draw site near West Chester. Results reviewed within 48 hours." },
              { icon: <Package className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Medications Delivered to Your Door", desc: "Semaglutide, tirzepatide, BHRT, testosterone — shipped directly to your West Chester address, discreetly and on schedule." },
