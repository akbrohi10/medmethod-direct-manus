        ...
        <div className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center">
          <div>
            <nav className="flex items-center gap-1.5 text-xs font-semibold mb-6" style={{ color: "rgba(255,255,255,0.4)" }}>
              ...
              <span style={{ color: "#E8339E" }}>Doylestown</span>
            </nav>
            <p className="text-xs font-black tracking-widest uppercase mb-3" style={{ color: "#E8339E" }}>Doylestown, PA — Bucks County</p>
            <h1 className="font-black mb-5 leading-tight" style={{ fontSize: "clamp(2rem, 4vw, 3.2rem)", color: "#fff", letterSpacing: "-0.02em" }}>
              Menopause & Weight Loss Care in <span style={{ color: "#E8339E" }}>Doylestown, PA</span>
            </h1>
            <p className="text-base font-medium mb-8 max-w-lg" style={{ color: "rgba(255,255,255,0.6)", lineHeight: 1.7 }}>Board-certified physicians. GLP-1 therapy. Hormone optimization. 100% virtual — serving Doylestown and Bucks County.</p>
          ...
          <div className="relative rounded-2xl overflow-hidden" style={{ aspectRatio: "16/10" }}>
            ...
            <img src={HERO_IMAGE} alt="Telehealth consultation for women's health in Doylestown, PA" className="w-full h-full object-cover" />
          </div>
        </div>
      </section>
