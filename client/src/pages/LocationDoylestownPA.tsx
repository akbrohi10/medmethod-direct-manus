/**
 * MedMethod Direct — Doylestown, PA (Bucks County)
...
const HERO_IMAGE = "https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/pa-hero-doylestown-6d6M948QBuxdbKWCDnfXJ5.webp";

const faqs = [
  { q: "Is MedMethod Direct licensed to practice in Pennsylvania?", a: "Yes. MedMethod Direct is fully licensed to practice medicine in Pennsylvania. Our board-certified physicians are authorized to evaluate, prescribe, and manage hormone therapy and medical weight loss programs for patients throughout the Commonwealth — including Doylestown and Bucks County — entirely via telehealth, with no in-person visit required." },
  { q: "Do I need to visit an office to become a patient in Doylestown?", a: "No. MedMethod Direct is a 100% virtual practice. Everything — your consultation, lab review, prescription, and ongoing check-ins — happens online via secure video. Your medication ships directly from a licensed 503B compounding pharmacy to your Doylestown address." },
  { q: "Why do Doylestown women choose MedMethod Direct?", a: "Doylestown is the cultural and civic heart of Bucks County — a community known for its arts scene, historic charm, and a well-educated, health-conscious population. Women here are accustomed to quality and convenience. MedMethod Direct delivers physician-led hormone therapy and GLP-1 weight loss care without requiring a drive to Philadelphia or a months-long wait for a specialist appointment." },
  { q: "Does MedMethod Direct serve all of Bucks County?", a: "Yes. MedMethod Direct serves patients across Bucks County, including Doylestown, New Hope, Newtown, Yardley, and Langhorne. Because we are 100% virtual, your location within the county does not affect access — you receive the same physician-led care regardless of where you live in Bucks County." },
  { q: "What services does MedMethod Direct offer Doylestown patients?", a: "We offer bioidentical hormone replacement therapy (BHRT), GLP-1 medical weight loss (semaglutide and tirzepatide), perimenopause and menopause management, and testosterone optimization. All programs are personalized based on your lab results and health history, with ongoing physician oversight included." },
...
export default function LocationDoylestownPA() {
  ...
  return (
    <>
      <Helmet>
        <title>Doylestown PA Women's Health | Hormone Therapy & Weight Loss | MedMethod Direct</title>
        <meta name="description" content="Virtual hormone therapy & GLP-1 weight loss for women in Doylestown, PA. Board-certified physicians, no office visit. Serving Bucks County and surrounding communities." />
        <link rel="canonical" href="https://www.medmethoddirect.com/pennsylvania/doylestown" />
        <meta property="og:title" content="Doylestown PA Women's Health | MedMethod Direct" />
        <meta property="og:description" content="Virtual hormone therapy & GLP-1 weight loss for women in Doylestown, PA. Board-certified physicians, no office visit required." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.medmethoddirect.com/pennsylvania/doylestown" />
        <meta property="og:image" content={HERO_IMAGE} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Doylestown PA Women's Health | MedMethod Direct" />
        <meta name="twitter:description" content="Virtual hormone therapy & GLP-1 weight loss for women in Doylestown, PA. Board-certified physicians, no office visit required." />
        <meta name="twitter:image" content={HERO_IMAGE} />
        <script type="application/ld+json">{JSON.stringify({ "@context": "https://schema.org", "@type": "MedicalBusiness", "name": "MedMethod Direct", "url": "https://www.medmethoddirect.com/pennsylvania/doylestown", "description": "MedMethod Direct provides virtual hormone therapy and GLP-1 weight loss programs for women in Doylestown, PA and Bucks County.", "medicalSpecialty": ["Endocrinology", "Obstetrics and Gynecology", "Internal Medicine"], "areaServed": { "@type": "City", "name": "Doylestown, Pennsylvania" }, "availableService": [{ "@type": "MedicalTherapy", "name": "Hormone Replacement Therapy" }, { "@type": "MedicalTherapy", "name": "Medical Weight Loss" }, { "@type": "MedicalTherapy", "name": "Menopause Management" }] })}</script>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 lg:py-16">
            ...
            <div>
              <nav className="flex items-center gap-2 text-xs font-semibold mb-5" style={{ color: "#aaa", fontFamily: "Montserrat, sans-serif" }}>
                ...
                <span>/</span>
                <span style={{ color: "#333" }}>Doylestown</span>
              </nav>
              <div
              ...
              >
                ...
                <br />
                for Doylestown women
              </h1>
              <p
                className="text-base mb-6 leading-relaxed"
                style={{ fontFamily: "Montserrat, sans-serif", color: "#555", maxWidth: "480px" }}
              >
                A virtual clinic combining physician-prescribed hormone therapy, GLP-1 medical weight loss, and menopause care — all in one program, for women in Doylestown, PA.
              </p>
              ...
              >
                <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 16 16" fill="none">
                  <circle cx="8" cy="8" r="8" fill="url(#vcGradDoylestown)"/>
                  <path d="M4.5 8.5l2.5 2.5 4.5-5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <defs><linearGradient id="vcGradDoylestown" x1="0" y1="0" x2="16" y2="16" gradientUnits="userSpaceOnUse"><stop stopColor="#E8339E"/><stop offset="1" stopColor="#7A1E7E"/></linearGradient></defs>
                </svg>
            ...
            <div className="relative lg:-ml-6">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ aspectRatio: "4/3" }}>
                <img
                  src="https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/pa-hero-doylestown-6d6M948QBuxdbKWCDnfXJ5.webp"
                  alt="Virtual menopause doctor and hormone therapy for women in Doylestown, PA — MedMethod Direct"
                ...
                >
                  <p className="text-white font-bold text-sm tracking-wide" style={{ fontFamily: "Montserrat, sans-serif" }}>
                    Serving Doylestown · New Hope · Newtown · Yardley
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4 text-base leading-relaxed" style={{ color: "#444" }}>
            ...
            <p>
              ...
              <strong>perimenopause weight gain</strong>, brain fog, night sweats, low libido, or you've tried GLP-1s elsewhere and hit a plateau — the missing piece is almost always hormonal. MedMethod Direct is one of the few virtual practices in Pennsylvania that addresses <strong>weight loss and hormone balance together</strong>, in a single physician-led program. No driving to Philadelphia or Princeton. No waiting rooms. Just one team, one plan, and results that last.
            </p>
          </div>
      ...
      {/* ── WHY DOYLESTOWN WOMEN CHOOSE US ── */}
        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="font-black text-[#111111]" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.2rem)", letterSpacing: "-0.02em" }}>
              Built for Busy Bucks County Women
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: <MapPin className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Lab Work Near Doylestown", desc: "We order your labs to a convenient LabCorp or Quest draw site near Doylestown. Results reviewed within 48 hours." },
              { icon: <Package className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Medications Delivered to Your Door", desc: "Semaglutide, tirzepatide, BHRT, testosterone — shipped directly to your Doylestown address, discreetly and on schedule." },
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { quote: "After my divorce at 49 I decided it was time to invest in myself for the first time in 25 years. MedMethod was the best decision I made. The hormone therapy cleared the brain fog I didn't even realize I had, and the GLP-1 helped me lose the 40 lbs I'd been carrying since my second pregnancy. I feel like I'm meeting myself again for the first time.", name: "Lisa M.", location: "Doylestown, PA", rating: 5 },
              { quote: "I was skeptical about virtual care — I'm old school, I like seeing my doctor in person. But after waiting 11 weeks for an endocrinologist appointment that lasted 8 minutes, I gave MedMethod a try. My initial consultation was 45 minutes. They actually listened. My performance coach follows up weekly. I get more attention virtually than I ever got in person. Down 16 lbs in 10 weeks.", name: "Deborah T.", location: "Pennsylvania Area", rating: 5 },
              { quote: "I'm a CrossFit athlete and I was furious that perimenopause was undoing years of hard work. I was gaining fat, losing muscle, and my recovery was terrible. MedMethod optimized my hormones — testosterone, estrogen, progesterone — and within two months my body composition started shifting back. My coach couldn't believe the difference. This isn't just for weight loss; it's for women who refuse to slow down.", name: "Amanda K.", location: "Pennsylvania Patient", rating: 5 },
].map((t) => (
        ...
        <div className="max-w-[900px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-10">
            ...
            <h2 className="font-black leading-tight" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.4rem)", color: "#111111" }}>
              Frequently Asked Questions for{" "}<span style={{backgroundImage: "linear-gradient(135deg, #E8339E 0%, #7A1E7E 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent"}}>Doylestown Patients</span>
            </h2>
          </div>
          {/* Tab buttons */}
      ...
      <section className="py-20 px-6 text-center" style={{ background: "#0d0d0d" }}>
        ...
        <h2 className="font-black text-3xl mb-4 text-white" style={{ letterSpacing: "-0.02em" }}>Ready to Start in Doylestown?</h2>
