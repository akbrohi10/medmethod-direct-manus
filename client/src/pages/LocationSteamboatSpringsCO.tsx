...
const HERO_IMAGE = "https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/co-t2-steamboat-springs_fb4e5bcf.png";
const BOOK_URL = "https://app.medmethoddirect.com/booking";

const faqs = [
  {
    "q": "Is there a menopause specialist in Steamboat Springs, CO?",
    "a": "Steamboat Springs has limited specialist medical care \u2014 the nearest menopause physicians are in Denver, nearly 3 hours away. MedMethod Direct provides board-certified hormone therapy via telehealth so Steamboat Springs women get specialist-level care without the long drive."
  },
  {
    "q": "Can I get HRT prescribed online in Colorado?",
    "a": "Yes. Colorado-licensed physicians can prescribe hormone replacement therapy via telehealth. MedMethod Direct physicians are CO-licensed and can prescribe bioidentical HRT shipped to your Steamboat Springs address."
  },
  {
    "q": "What does the $449 diagnostic setup include?",
    "a": "Your $449 onboarding includes a comprehensive hormone and metabolic lab panel, a 60-minute physician consultation, and a personalized treatment protocol. Labs can be drawn at a local facility near Steamboat Springs."
  },
  {
    "q": "Do you offer GLP-1 weight loss in Steamboat Springs?",
    "a": "Yes. We offer semaglutide and tirzepatide programs for women in Steamboat Springs and throughout Northwest Colorado. Your physician evaluates your metabolic health and prescribes the appropriate GLP-1 medication shipped directly to you."
  },
  {
    "q": "Do you serve other mountain communities in Colorado?",
    "a": "Yes \u2014 we serve all Colorado residents including those in Vail, Aspen, Breckenridge, Telluride, and Durango. Any Colorado resident can schedule a telehealth appointment regardless of their location."
  }
];
...
export default function LocationSteamboatSpringsCO() {
  const schema = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "MedicalBusiness",
        name: "MedMethod Direct — Steamboat Springs, CO",
        url: "https://www.medmethoddirect.com/steamboat-springs-co",
        description: "Board-certified telehealth menopause and hormone therapy for women in Steamboat Springs, Colorado.",
        areaServed: { "@type": "City", name: "Steamboat Springs", containedInPlace: { "@type": "State", name: "Colorado" } },
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Steamboat Springs", item: "https://www.medmethoddirect.com/steamboat-springs-co" }
        ]
      }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        <title>Menopause Doctor Steamboat Springs CO | Hormone Therapy | MedMethod Direct</title>
        <meta name="description" content="Board-certified menopause and hormone therapy for women in Steamboat Springs, CO. Specialist-level HRT via telehealth — no 3-hour drive to Denver required." />
        <link rel="canonical" href="https://www.medmethoddirect.com/steamboat-springs-co" />
        <meta property="og:title" content="Menopause Doctor Steamboat Springs CO | MedMethod Direct" />
        <meta property="og:description" content="Board-certified menopause and hormone therapy for women in Steamboat Springs, CO. Specialist-level HRT via telehealth — no 3-hour drive to Denver required." />
        <meta property="og:url" content="https://www.medmethoddirect.com/steamboat-springs-co" />
      ...
      <nav className="bg-stone-50 border-b border-stone-200 py-3 px-4 text-sm text-stone-500">
        <div className="max-w-5xl mx-auto flex gap-2">
          ...
          <span>/</span>
          <span className="text-stone-800 font-medium">Steamboat Springs</span>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 lg:py-16">
            ...
            <div>
              <nav className="flex items-center gap-2 text-xs font-semibold mb-5" style={{ color: "#aaa", fontFamily: "Montserrat, sans-serif" }}>
                ...
                <span>/</span>
                <Link href="/colorado" className="hover:text-[#E8339E] transition-colors">Colorado</Link>
                <span>/</span>
                <span style={{ color: "#333" }}>Steamboat Springs</span>
              </nav>
              <div
              ...
              >
                ...
                <br />
                for Steamboat Springs women
              </h1>
              <p
                className="text-base mb-6 leading-relaxed"
                style={{ fontFamily: "Montserrat, sans-serif", color: "#555", maxWidth: "480px" }}
              >
                The only virtual clinic combining physician-prescribed hormone therapy, GLP-1 medical weight loss, and menopause care — all in one program, for women in Steamboat Springs, CO.
              </p>
              ...
              >
                <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 16 16" fill="none">
                  <circle cx="8" cy="8" r="8" fill="url(#vcGradSteamboatSprings)"/>
                  <path d="M4.5 8.5l2.5 2.5 4.5-5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <defs><linearGradient id="vcGradSteamboatSprings" x1="0" y1="0" x2="16" y2="16" gradientUnits="userSpaceOnUse"><stop stopColor="#E8339E"/><stop offset="1" stopColor="#7A1E7E"/></linearGradient></defs>
                </svg>
                100% Virtual Care · Licensed in Colorado
              </p>
            ...
            <div className="relative lg:-ml-6">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ aspectRatio: "4/3" }}>
                <img
                  src="https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/co-t2-steamboat-springs_fb4e5bcf.png"
                  alt="Virtual menopause doctor and hormone therapy for women in Steamboat Springs, CO — MedMethod Direct"
                ...
                >
                  <p className="text-white font-bold text-sm tracking-wide" style={{ fontFamily: "Montserrat, sans-serif" }}>
                    Serving Steamboat Springs · Craig · Hayden · Yampa
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4 text-base leading-relaxed" style={{ color: "#444" }}>
            ...
            <p>
              ...
              <strong>perimenopause weight gain</strong>, brain fog, night sweats, low libido, or you've tried GLP-1s elsewhere and hit a plateau — the missing piece is almost always hormonal. MedMethod Direct is one of the only virtual practices in Colorado that addresses <strong>weight loss and hormone balance together</strong>, in a single physician-led program. No driving to Denver or Vail. No waiting rooms. Just one team, one plan, and results that last.
            </p>
          </div>
      ...
      {/* ── WHY STEAMBOAT SPRINGS WOMEN CHOOSE US ── */}
        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="font-black text-[#111111]" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.2rem)", letterSpacing: "-0.02em" }}>
              Built for Busy Routt County Women
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: "🧪", title: "Lab Work Near Steamboat Springs", desc: "We order your labs to a convenient LabCorp or Quest draw site near Steamboat Springs. Results reviewed within 48 hours." },
              { icon: "📦", title: "Medications Delivered to Your Door", desc: "Semaglutide, tirzepatide, BHRT, testosterone — shipped directly to your Steamboat Springs address, discreetly and on schedule." },
        ...
        <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="font-black text-[#111111]" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.8rem, 3.5vw, 2.6rem)", letterSpacing: "-0.02em" }}>
              What Women in Colorado Are Saying
            </h2>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { stars: 5, quote: "I finally found a doctor who listens. My energy is back, my sleep is better, and I\'ve lost 18 lbs in 3 months. I wish I\'d started sooner.", name: "Sarah M.", loc: "Steamboat Springs, Colorado" },
              { stars: 5, quote: "The convenience of virtual visits is a game-changer. No more sitting in waiting rooms. My hormone levels are balanced for the first time in years.", name: "Jennifer L.", loc: "Steamboat Springs Area" },
        ...
        <div className="max-w-[800px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="font-black leading-tight" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.4rem)", color: "#111111" }}>
              Frequently Asked Questions for{" "}<span style={{background: "linear-gradient(135deg, #E8339E 0%, #7A1E7E 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent"}}>Steamboat Springs Patients</span>
            </h2>
          </div>
          <div>
            {faqs.map((faq) => (
