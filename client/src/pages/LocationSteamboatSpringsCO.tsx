        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: <MapPin className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Lab Work Near Steamboat Springs", desc: "We order your labs to a convenient LabCorp or Quest draw site near Steamboat Springs. Results reviewed within 48 hours." },
              { icon: <Package className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Medications Delivered to Your Door", desc: "Semaglutide, tirzepatide, BHRT, testosterone — shipped directly to your Steamboat Springs address, discreetly and on schedule." },
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { stars: 5, quote: 'I\'m an avid hiker and skier and I was terrified that menopause was going to sideline me. My recovery was terrible, my energy was gone by noon, and I\'d gained 20 lbs despite being active every day. MedMethod optimized my hormones and added a GLP-1 — within three months I was back on 14ers and my body felt like mine again. Colorado women don\'t slow down, and neither should our healthcare.', name: "Kimberly H.", loc: "Steamboat Springs, CO" },
              { stars: 5, quote: 'Living at altitude makes everything harder — including menopause. The dehydration, the sleep disruption, the fatigue. My MedMethod physician understood the altitude factor and adjusted my protocol accordingly. My performance coach even helped me plan hydration and nutrition around my hiking schedule. This is personalized care that actually accounts for how I live, not just what my labs say.', name: "Sarah N.", loc: "Colorado Area" },
