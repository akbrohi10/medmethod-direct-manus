...
import { CheckCircle, Mail, MessageSquare, UserPlus, ArrowRight } from "lucide-react";
...
const STEPS = [
  ...
  },
  {
    ...
    description:
      "Check your email for a calendar invitation and accept it now. This confirms your time slot with Dr. Al-Deek.",
    color: BRAND_PLUM,
    link: null,
  },
  {
    ...
    description:
      "You'll receive a confirmation text shortly. Reply to confirm and lock in your time. Unconfirmed appointments are released within 24 hours.",
    color: BRAND_PINK,
    link: null,
  },
];
          ...
          <div className="bg-white rounded-2xl border border-[#e8e6e3] shadow-sm overflow-hidden">
            <div className="px-6 pt-5 pb-3 border-b border-[#f0eee9]">
              <h2
                ...
                style={{ fontFamily: "Montserrat, sans-serif" }}
              >
                Book Your 15-Minute Visit with Dr. Al-Deek
              </h2>
              <p
          ...
          <div className="bg-white rounded-2xl border border-[#e8e6e3] divide-y divide-[#f0eee9]">
            <div className="flex items-start gap-3 px-5 py-4">
              ...
              <p className="text-sm text-[#4a4a5a] leading-relaxed" style={{ fontFamily: "Montserrat, sans-serif" }}>
                <strong className="text-[#1a1a2e]">Dr. Al-Deek will review your intake information</strong> before the visit so your consultation is personalized from the first minute.
              </p>
            </div>
            <div className="flex items-start gap-3 px-5 py-4">
              <span className="text-[#E8339E] mt-0.5 flex-shrink-0">💳</span>
              <p className="text-sm text-[#4a4a5a] leading-relaxed" style={{ fontFamily: "Montserrat, sans-serif" }}>
                <strong className="text-[#1a1a2e]">Your $15 hold is fully refunded when you attend</strong> — even if you decide not to continue.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-lg mb-10">
          ...
          >
            ...
            <div className="text-left">
              <span className="block text-lg font-bold" style={{ fontFamily: "Montserrat, sans-serif" }}>(888) 362-7011</span>
              <span className="block text-xs text-white/80 font-medium" style={{ fontFamily: "Montserrat, sans-serif" }}>Questions? Call us anytime</span>
            </div>
          </a>
        </div>
