...
const HERO_IMAGE = "https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/dc-t2-tysons_7377dbdb.png";
const BOOK_URL = "https://app.medmethoddirect.com/booking";

const faqs = [
  {
    "q": "Is there a menopause specialist in Tysons, VA?",
    "a": "Tysons has general OB-GYN practices, but dedicated menopause specialists managing comprehensive HRT with a longevity focus have long wait times. MedMethod Direct provides board-certified hormone therapy via telehealth with appointments available this week."
  },
  {
    "q": "Can I get HRT prescribed online in Virginia?",
    "a": "Yes. Virginia-licensed physicians can prescribe hormone replacement therapy via telehealth. MedMethod Direct physicians are VA-licensed and can prescribe bioidentical HRT shipped to your Tysons address."
  },
  {
  ...
  {
    "q": "Do you offer GLP-1 weight loss in Tysons?",
  ...
  {
    "q": "Do you serve other Fairfax County communities?",
    "a": "Yes \u2014 we serve all of Fairfax County including McLean, Reston, Herndon, Vienna, and Fairfax City. Any Virginia resident can schedule a telehealth appointment."
  },
  {
...
export default function LocationTysonsVA() {
    ...
    "@graph": [
      {
        ...
        name: "MedMethod Direct — Tysons, VA",
        url: "https://www.medmethoddirect.com/tysons-va",
        description: "Board-certified telehealth menopause and hormone therapy for women in Tysons, Virginia.",
        areaServed: { "@type": "City", name: "Tysons", containedInPlace: { "@type": "State", name: "Virginia" } },
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Tysons", item: "https://www.medmethoddirect.com/tysons-va" }
        ]
      }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        <title>Menopause Doctor Tysons VA | Hormone Therapy | MedMethod Direct</title>
        <meta name="description" content="Board-certified menopause and hormone therapy for women in Tysons, VA. Specialist-level HRT and GLP-1 weight loss via telehealth — appointments available this week." />
        <link rel="canonical" href="https://www.medmethoddirect.com/tysons-va" />
        <meta property="og:title" content="Menopause Doctor Tysons VA | MedMethod Direct" />
        <meta property="og:description" content="Board-certified menopause and hormone therapy for women in Tysons, VA. Specialist-level HRT and GLP-1 weight loss via telehealth — appointments available this week." />
        <meta property="og:url" content="https://www.medmethoddirect.com/tysons-va" />
      ...
      <nav className="bg-stone-50 border-b border-stone-200 py-3 px-4 text-sm text-stone-500">
        <div className="max-w-5xl mx-auto flex gap-2">
          ...
          <span>/</span>
          <span className="text-stone-800 font-medium">Tysons</span>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 lg:py-16">
            ...
            <div>
              <nav className="flex items-center gap-2 text-xs font-semibold mb-5" style={{ color: "#aaa", fontFamily: "Montserrat, sans-serif" }}>
                ...
                <span>/</span>
                <span style={{ color: "#333" }}>Tysons</span>
              </nav>
              <div
              ...
              >
                The only virtual clinic combining physician-prescribed hormone therapy, GLP-1 medical weight loss, and menopause care — all in one program, for women in Tysons, VA.
              </p>
              ...
              >
                <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 16 16" fill="none">
                  <circle cx="8" cy="8" r="8" fill="url(#vcGradTysons)"/>
                  <path d="M4.5 8.5l2.5 2.5 4.5-5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <defs><linearGradient id="vcGradTysons" x1="0" y1="0" x2="16" y2="16" gradientUnits="userSpaceOnUse"><stop stopColor="#E8339E"/><stop offset="1" stopColor="#7A1E7E"/></linearGradient></defs>
                </svg>
            ...
            <div className="relative lg:-ml-6">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ aspectRatio: "4/3" }}>
                <img
                  src="https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/dc-t2-tysons_7377dbdb.png"
                  alt="Virtual menopause doctor and hormone therapy for women in Tysons, VA — MedMethod Direct"
                ...
                >
                  <p className="text-white font-bold text-sm tracking-wide" style={{ fontFamily: "Montserrat, sans-serif" }}>
                    Serving Tysons · McLean · Vienna · Reston
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-4 text-base leading-relaxed" style={{ color: "#444" }}>
            ...
            <p>
              ...
              <strong>perimenopause weight gain</strong>, brain fog, night sweats, low libido, or you've tried GLP-1s elsewhere and hit a plateau — the missing piece is almost always hormonal. MedMethod Direct is one of the only virtual practices in Virginia that addresses <strong>weight loss and hormone balance together</strong>, in a single physician-led program. No driving to McLean or Reston. No waiting rooms. Just one team, one plan, and results that last.
            </p>
          </div>
        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: <MapPin className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Lab Work Near Tysons", desc: "We order your labs to a convenient LabCorp or Quest draw site near Tysons. Results reviewed within 48 hours." },
              { icon: <Package className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Medications Delivered to Your Door", desc: "Semaglutide, tirzepatide, BHRT, testosterone — shipped directly to your Tysons address, discreetly and on schedule." },
