        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
           ...
           <a
            ...
            <button
              onClick={openConsult}
              className="bg-gradient-to-r from-[#E8339E] to-[#7A1E7E] text-white font-semibold text-[11px] sm:text-[13px] px-3 sm:px-5 py-1.5 sm:py-2 rounded-full hover:opacity-90 transition-opacity whitespace-nowrap shrink-0"
              style={{ fontFamily: "Montserrat, sans-serif" }}
            >
              Book Now
            </button>
