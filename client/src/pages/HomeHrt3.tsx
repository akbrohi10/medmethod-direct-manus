  ...
  return (
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-100 shadow-sm">
        <div className="grid h-16 w-full grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center px-2 sm:h-[4.25rem] sm:px-6 lg:px-8">
          {/* Logo — far left */}
          ...
          {/* Phone — centered stacked call-to-action */}
          <a
            href="tel:+18883627011"
            className="flex flex-col items-center justify-self-center whitespace-nowrap font-bold leading-none text-[#E8339E] transition-colors hover:text-[#7A1E7E] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E8339E] focus-visible:ring-offset-2"
            style={{ fontFamily: "Montserrat, sans-serif" }}
          >
            <span className="text-[8px] font-extrabold uppercase tracking-[0.16em] sm:text-[10px]">Call Now</span>
            <span className="mt-1 text-[14px] font-black tracking-[0.01em] sm:text-[18px]">(888) 362-7011</span>
          </a>
