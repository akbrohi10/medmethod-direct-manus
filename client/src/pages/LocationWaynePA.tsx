    ...
    <>
        ...
        <div className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center">
          <div>
            <nav className="flex items-center gap-1.5 text-xs font-semibold mb-6" style={{ color: "rgba(255,255,255,0.4)" }}>
              ...
              <span style={{ color: "#E8339E" }}>Wayne</span>
            </nav>
            <p className="text-xs font-black tracking-widest uppercase mb-3" style={{ color: "#E8339E" }}>Wayne, PA — Main Line</p>
            <h1 className="font-black mb-5 leading-tight" style={{ fontSize: "clamp(2rem, 4vw, 3.2rem)", color: "#fff", letterSpacing: "-0.02em" }}>
              Menopause & Weight Loss Care in <span style={{ color: "#E8339E" }}>Wayne, PA</span>
            </h1>
            <p className="text-base font-medium mb-8 max-w-lg" style={{ color: "rgba(255,255,255,0.6)", lineHeight: 1.7 }}>Board-certified physicians. GLP-1 therapy. Hormone optimization. 100% virtual — serving Wayne and the Philadelphia Main Line corridor.</p>
          ...
          <div className="relative rounded-2xl overflow-hidden" style={{ aspectRatio: "16/10" }}>
            ...
            <img src={HERO_IMAGE} alt="Telehealth consultation for women's health in Wayne, PA" className="w-full h-full object-cover" />
          </div>
        </div>
      </section>
      <section className="py-16 px-6" style={{ background: "#F4F4F8" }}>
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-base font-medium leading-relaxed mb-4" style={{ color: "#444" }}>Wayne is one of the crown jewels of the Philadelphia Main Line — a community with a median household income well above $185,000, tree-lined streets, and a strong culture of health and wellness. The town's proximity to Villanova University and its long history as a destination for Philadelphia's professional class means a high concentration of women 40–65 who are educated, health-literate, and actively seeking the best available care for perimenopause, hormone optimization, and medical weight loss.</p>
          <p className="text-base font-medium leading-relaxed mb-4" style={{ color: "#444" }}>MedMethod Direct fits the Wayne lifestyle precisely. Our board-certified physicians deliver personalized lab-based BHRT protocols, semaglutide and tirzepatide prescriptions, and ongoing physician oversight — all via telehealth, with medication shipped directly to your Wayne address. No drive to Center City, no waiting room, no compromise on quality.</p>
      ...
      <section className="py-20 px-6" style={{ background: "#fff" }}>
        <div className="max-w-3xl mx-auto">
          <h2 className="font-black text-3xl mb-10 text-center" style={{ color: "#111", letterSpacing: "-0.02em" }}>Frequently Asked Questions — Wayne</h2>
