...
const JSONLD_FAQ = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": { "@type": "Answer", "text": "Most local practices in Miami have 3–6 week wait times for new patients, and appointments are often limited to 10–15 minutes. You get more time, more attention, and deeper expertise — all from your home or condo in Miami." },
    },
  ],
};
...
const localFaqs = [
  ...
  { q: "Can Miami patients get medications delivered to their home?", a: "Yes. Medication fulfillment depends on the prescription and dispensing pharmacy. If medication is clinically appropriate, Dr. Al-Deek will explain available shipping or local pharmacy options during your visit." },
  { q: "Can I get semaglutide or tirzepatide online in Miami?", a: "Yes. After reviewing your health history and clinical needs, Dr. Al-Deek can prescribe an appropriate medication when indicated. Medication selection, pharmacy fulfillment, and insurance considerations are discussed during your visit. If a compounded medication is considered, it is not FDA-approved, and FDA does not review compounded drugs for safety, effectiveness, or quality before marketing." },
  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: "Montserrat, sans-serif" }}>
      <Helmet>
        ...
        <meta name="description" content="Expert virtual hormone therapy, GLP-1 medical weight loss & menopause care for women in Miami, FL. Physician-prescribed semaglutide, BHRT & testosterone. See a doctor this week — appointment." />
        ...
        <meta property="og:description" content="Expert virtual hormone therapy, GLP-1 medical weight loss & menopause care for women in Miami, FL. Physician-prescribed semaglutide, BHRT & testosterone. appointment." />
        ...
        <meta name="twitter:description" content="Expert virtual hormone therapy, GLP-1 medical weight loss & menopause care for women in Miami, FL. Physician-prescribed semaglutide, BHRT & testosterone. appointment." />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
              <div>
                ...
                <p className="text-base mb-6 leading-relaxed" style={{ fontFamily: "Montserrat, sans-serif", color: "#555", maxWidth: "480px" }}>
                  A virtual clinic combining physician-prescribed hormone therapy, GLP-1 medical weight loss, and menopause care — all in one program, for women in Miami and South Florida.
                </p>
        ...
        <div className="max-w-[900px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-10">
            ...
            <h2 className="font-black leading-tight" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.4rem)", color: "#111111" }}>
              Frequently Asked Questions for{" "}<span style={{backgroundImage: "linear-gradient(135deg, #E8339E 0%, #7A1E7E 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent"}}>Miami Patients</span>
            </h2>
          </div>
          {/* Tab buttons */}
      ...
      <section className="py-20" style={{ background: "linear-gradient(135deg, #E8339E 0%, #B040B0 50%, #7A1E7E 100%)" }}>
        <div className="max-w-[700px] mx-auto px-4 text-center">
          ...
          <p className="text-white/85 text-base leading-relaxed mb-8 max-w-xl mx-auto" style={{ fontFamily: "Montserrat, sans-serif" }}>
            Miami women deserve more than a rushed appointment and a prescription handed to them on the way out the door. You deserve a physician who knows your name, knows your labs, and is building a plan specifically for you. Your appointment is 20 minutes and completely obligation-free.
          </p>
