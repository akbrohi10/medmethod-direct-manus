  ...
  return (
    <>
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-stone-600 leading-relaxed mb-4">
              Palm Beach Gardens attracts affluent professionals and retirees seeking Florida's best quality of life — but dedicated menopause specialists managing comprehensive HRT are concentrated in Boca Raton or West Palm Beach. Women in the Gardens deserve specialist-level care without the commute.
            </p>
            <p className="text-stone-600 leading-relaxed">
              MedMethod Direct brings specialist-level care directly to Palm Beach Gardens women. Our Florida-licensed physicians provide comprehensive menopause management and hormone therapy entirely via telehealth, with medication shipped to your address.
            </p>
          </div>
      ...
      <section className="bg-stone-50 py-16 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { step: "01", title: "Lab Work", desc: "Order your comprehensive hormone panel online. Labs drawn near Palm Beach Gardens — no physician referral needed." },
      ...
      <section className="bg-stone-800 py-16 px-6 text-center">
        ...
        <p className="text-stone-300 mb-8 max-w-xl mx-auto">Join Palm Beach Gardens women who are getting specialist-level hormone care from home.</p>
        <a href={BOOK_URL} target="_blank" rel="noopener noreferrer">
