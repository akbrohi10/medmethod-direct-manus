...
const HERO_IMAGE = "https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/dc-t2-alexandria_e6ca0b07.png";
const BOOK_URL = "https://app.medmethoddirect.com/booking";

const faqs = [
  {
    "q": "Is there a menopause specialist in Alexandria, VA?",
    "a": "Alexandria has general OB-GYN practices, but dedicated menopause specialists managing comprehensive HRT are concentrated in McLean or Bethesda. MedMethod Direct provides board-certified hormone therapy via telehealth so Alexandria women get specialist-level care without the commute."
  },
  {
    "q": "Can I get bioidentical HRT online in Virginia?",
    "a": "Yes. Virginia-licensed physicians can prescribe bioidentical hormone replacement therapy via telehealth. MedMethod Direct physicians are VA-licensed and prescribe customized bioidentical estrogen, progesterone, and testosterone shipped to your Alexandria address."
  },
  {
  ...
  {
    "q": "Do you offer GLP-1 weight loss in Alexandria?",
  ...
  },
  {
    ...
    "a": "Yes \u2014 we serve all of Northern Virginia including McLean, Falls Church, Tysons, Herndon, and Reston. Any Virginia resident can schedule a telehealth appointment."
  },
  {
...
export default function LocationAlexandriaVA() {
    ...
    "@graph": [
      {
        ...
        name: "MedMethod Direct — Alexandria, VA",
        url: "https://www.medmethoddirect.com/alexandria-va",
        description: "Board-certified telehealth menopause and hormone therapy for women in Alexandria, Virginia.",
        areaServed: { "@type": "City", name: "Alexandria", containedInPlace: { "@type": "State", name: "Virginia" } },
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Alexandria", item: "https://www.medmethoddirect.com/alexandria-va" }
        ]
      }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        <title>Menopause Doctor Alexandria VA | Hormone Therapy | MedMethod Direct</title>
        <meta name="description" content="Board-certified menopause and hormone therapy for women in Alexandria, VA. Specialist-level HRT and GLP-1 weight loss via telehealth — appointments available this week." />
        <link rel="canonical" href="https://www.medmethoddirect.com/alexandria-va" />
        <meta property="og:title" content="Menopause Doctor Alexandria VA | MedMethod Direct" />
        <meta property="og:description" content="Board-certified menopause and hormone therapy for women in Alexandria, VA. Specialist-level HRT and GLP-1 weight loss via telehealth — appointments available this week." />
        <meta property="og:url" content="https://www.medmethoddirect.com/alexandria-va" />
      ...
      <nav className="bg-stone-50 border-b border-stone-200 py-3 px-4 text-sm text-stone-500">
        <div className="max-w-5xl mx-auto flex gap-2">
          ...
          <span>/</span>
          <span className="text-stone-800 font-medium">Alexandria</span>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 lg:py-16">
            ...
            <div>
              <nav className="flex items-center gap-2 text-xs font-semibold mb-5" style={{ color: "#aaa", fontFamily: "Montserrat, sans-serif" }}>
                ...
                <span>/</span>
                <span style={{ color: "#333" }}>Alexandria</span>
              </nav>
              <div
              ...
              >
                ...
                <br />
                for Alexandria women
              </h1>
              <p
                className="text-base mb-6 leading-relaxed"
                style={{ fontFamily: "Montserrat, sans-serif", color: "#555", maxWidth: "480px" }}
              >
                A virtual clinic combining physician-prescribed hormone therapy, GLP-1 medical weight loss, and menopause care — all in one program, for women in Alexandria, VA.
              </p>
              ...
              >
                <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 16 16" fill="none">
                  <circle cx="8" cy="8" r="8" fill="url(#vcGradAlexandria)"/>
                  <path d="M4.5 8.5l2.5 2.5 4.5-5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <defs><linearGradient id="vcGradAlexandria" x1="0" y1="0" x2="16" y2="16" gradientUnits="userSpaceOnUse"><stop stopColor="#E8339E"/><stop offset="1" stopColor="#7A1E7E"/></linearGradient></defs>
                </svg>
            ...
            <div className="relative lg:-ml-6">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ aspectRatio: "4/3" }}>
                <img
                  src="https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/dc-t2-alexandria_e6ca0b07.png"
                  alt="Virtual menopause doctor and hormone therapy for women in Alexandria, VA — MedMethod Direct"
                ...
                >
                  <p className="text-white font-bold text-sm tracking-wide" style={{ fontFamily: "Montserrat, sans-serif" }}>
                    Serving Alexandria · Arlington · McLean · Falls Church
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-4 text-base leading-relaxed" style={{ color: "#444" }}>
            ...
            <p>
              ...
              <strong>perimenopause weight gain</strong>, brain fog, night sweats, low libido, or you've tried GLP-1s elsewhere and hit a plateau — the missing piece is almost always hormonal. MedMethod Direct is one of the few virtual practices in Virginia that addresses <strong>weight loss and hormone balance together</strong>, in a single physician-led program. No driving to Arlington or McLean. No waiting rooms. Just one team, one plan, and results that last.
            </p>
          </div>
      ...
      {/* ── WHY ALEXANDRIA WOMEN CHOOSE US ── */}
        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="font-black text-[#111111]" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.2rem)", letterSpacing: "-0.02em" }}>
              Built for Busy Northern Virginia Women
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: <MapPin className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Lab Work Near Alexandria", desc: "We order your labs to a convenient LabCorp or Quest draw site near Alexandria. Results reviewed within 48 hours." },
              { icon: <Package className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Medications Delivered to Your Door", desc: "Semaglutide, tirzepatide, BHRT, testosterone — shipped directly to your Alexandria address, discreetly and on schedule." },
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { stars: 5, quote: 'I\'m a federal contractor and my schedule is brutal — 6 AM calls, back-to-back meetings, zero time for myself. I kept putting off my health until the hot flashes made it impossible to focus during briefings. MedMethod got me started in under a week. Down 22 lbs, sleeping through the night, and my performance coach checks in every week to keep me on track. That accountability piece was the game-changer.', name: "Katherine D.", loc: "Alexandria, VA" },
              { stars: 5, quote: 'I\'d been to three different OBGYNs about my perimenopause symptoms and kept hearing \'your labs are normal.\' Dr. Al-Deek looked at the same numbers and immediately saw what everyone else missed. Within 60 days my brain fog lifted, the anxiety dropped, and I lost 14 pounds without changing my diet. I just needed someone who actually understood hormones.', name: "Priya S.", loc: "Virginia Area" },
              { stars: 5, quote: 'After my youngest left for college I realized I\'d spent 20 years taking care of everyone except myself. I was 52, exhausted, and had gained 35 pounds since perimenopause started. The combination of HRT and GLP-1 was exactly what I needed — but honestly, it was my performance coach who kept me from quitting during month two when the scale stalled. She reminded me to trust the process. Down 28 lbs now.', name: "Diane W.", loc: "Virginia" },
            ].map((t, i) => (
