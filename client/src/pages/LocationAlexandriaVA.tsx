        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: "🧪", title: "Lab Work Near Alexandria", desc: "We order your labs to a convenient LabCorp or Quest draw site near Alexandria. Results reviewed within 48 hours." },
              { icon: "📦", title: "Medications Delivered to Your Door", desc: "Semaglutide, tirzepatide, BHRT, testosterone — shipped directly to your Alexandria address, discreetly and on schedule." },
