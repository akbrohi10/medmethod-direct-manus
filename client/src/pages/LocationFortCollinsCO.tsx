    ...
    <>
        ...
        <div className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center">
          <div>
            <nav className="flex items-center gap-1.5 text-xs font-semibold mb-6" style={{ color: "rgba(255,255,255,0.4)", fontFamily: "Montserrat, sans-serif" }}>
              ...
              <span style={{ color: "#E8339E" }}>Fort Collins</span>
            </nav>
            <p className="text-xs font-black tracking-widest uppercase mb-3" style={{ color: "#E8339E", fontFamily: "Montserrat, sans-serif" }}>Fort Collins, CO — CSU Corridor</p>
            <h1 className="font-black mb-5 leading-tight" style={{ fontSize: "clamp(2rem, 4vw, 3.2rem)", color: "#fff", letterSpacing: "-0.02em", fontFamily: "Montserrat, sans-serif" }}>
              Menopause & Weight Loss Care in <span style={{ color: "#E8339E" }}>Fort Collins, CO</span>
            </h1>
            <p className="text-base font-medium mb-8 max-w-lg" style={{ color: "rgba(255,255,255,0.6)", lineHeight: 1.7, fontFamily: "Montserrat, sans-serif" }}>Physician-led hormone therapy and GLP-1 programs for Fort Collins women. Board-certified. 100% virtual. Northern Colorado's telehealth women's health practice.</p>
          ...
          <div className="relative rounded-2xl overflow-hidden" style={{ aspectRatio: "16/10" }}>
            ...
            <img src={HERO_IMAGE} alt="Telehealth consultation for women's health in Fort Collins, CO" className="w-full h-full object-cover" />
          </div>
        </div>
      </section>
      <section className="py-16 px-6" style={{ background: "#F4F4F8" }}>
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-base font-medium leading-relaxed mb-4" style={{ color: "#444", fontFamily: "Montserrat, sans-serif" }}>Fort Collins is one of Colorado's most livable cities — a vibrant community anchored by Colorado State University, a thriving craft and tech industry, and an outdoor culture that attracts health-conscious residents from across the Front Range. Women in Fort Collins are among the most health-literate in the state, yet Northern Colorado remains significantly underserved by women's health specialists. The nearest endocrinologist or menopause specialist is often a 45-minute drive to Denver, with wait times of three months or more.</p>
          <p className="text-base font-medium leading-relaxed mb-4" style={{ color: "#444", fontFamily: "Montserrat, sans-serif" }}>MedMethod Direct brings specialist-level care directly to Fort Collins women. Our board-certified physicians deliver personalized BHRT, semaglutide and tirzepatide GLP-1 programs, and comprehensive menopause management via telehealth — with medication shipped directly to your Fort Collins address from a licensed 503B compounding pharmacy.</p>
