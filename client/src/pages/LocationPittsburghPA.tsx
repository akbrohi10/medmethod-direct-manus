    ...
    <>
        ...
        <div className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center">
          <div>
            <nav className="flex items-center gap-1.5 text-xs font-semibold mb-6" style={{ color: "rgba(255,255,255,0.4)" }}>
              ...
              <span style={{ color: "#E8339E" }}>Pittsburgh</span>
            </nav>
            <p className="text-xs font-black tracking-widest uppercase mb-3" style={{ color: "#E8339E" }}>Pittsburgh, PA</p>
            <h1 className="font-black mb-5 leading-tight" style={{ fontSize: "clamp(2rem, 4vw, 3.2rem)", color: "#fff", letterSpacing: "-0.02em" }}>
              Menopause & Weight Loss Care in <span style={{ color: "#E8339E" }}>Pittsburgh, PA</span>
            </h1>
            <p className="text-base font-medium mb-8 max-w-lg" style={{ color: "rgba(255,255,255,0.6)", lineHeight: 1.7 }}>Board-certified physicians. GLP-1 therapy. Hormone optimization. 100% virtual — serving Shadyside, Fox Chapel & the Pittsburgh metro.</p>
          ...
          <div className="relative rounded-2xl overflow-hidden" style={{ aspectRatio: "16/10" }}>
            ...
            <img src={HERO_IMAGE} alt="Telehealth consultation for women's health in Pittsburgh, PA" className="w-full h-full object-cover" />
          </div>
        </div>
      </section>
      <section className="py-16 px-6" style={{ background: "#F4F4F8" }}>
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-base font-medium leading-relaxed mb-4" style={{ color: "#444" }}>Pittsburgh has undergone a remarkable transformation over the past two decades — from steel city to a thriving hub of technology, healthcare, and higher education. Neighborhoods like Shadyside and Squirrel Hill attract young professionals and established families with high household incomes, while Fox Chapel and the South Hills communities are among the most affluent in western Pennsylvania. Women in these communities are health-forward, well-informed, and increasingly seeking out the kind of personalized, evidence-based care that MedMethod Direct provides.</p>
          <p className="text-base font-medium leading-relaxed mb-4" style={{ color: "#444" }}>UPMC is one of the largest health systems in the country and a genuine center of medical excellence. But its sheer size means that specialist appointments for perimenopause management and hormone therapy are often booked months out. MedMethod Direct provides the same quality of physician-led care — personalized lab-based BHRT protocols, semaglutide and tirzepatide prescriptions, and ongoing oversight — via telehealth, with medication shipped directly to your Pittsburgh address.</p>
      ...
      <section className="py-20 px-6" style={{ background: "#fff" }}>
        <div className="max-w-3xl mx-auto">
          <h2 className="font-black text-3xl mb-10 text-center" style={{ color: "#111", letterSpacing: "-0.02em" }}>Frequently Asked Questions — Pittsburgh</h2>
