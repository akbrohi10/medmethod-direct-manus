...
const HERO_IMAGE = "https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/co-t2-loveland_f8b44784.png";
const BOOK_URL = "https://app.medmethoddirect.com/booking";

const faqs = [
  {
    "q": "Is there a menopause specialist in Loveland, CO?",
    "a": "Loveland and Larimer County have limited menopause specialists \u2014 most are in Fort Collins or Denver. MedMethod Direct provides board-certified hormone therapy via telehealth so Loveland women get specialist-level care without the drive."
  },
  {
    "q": "Can I get bioidentical HRT online in Colorado?",
    "a": "Yes. Colorado-licensed physicians can prescribe bioidentical hormone replacement therapy via telehealth. MedMethod Direct physicians are CO-licensed and prescribe customized bioidentical estrogen, progesterone, and testosterone shipped to your Loveland address."
  },
  {
  ...
  {
    "q": "Do you offer GLP-1 weight loss in Loveland?",
    "a": "Yes. We offer semaglutide and tirzepatide programs for women throughout Larimer County. Your physician evaluates your metabolic health and prescribes the appropriate GLP-1 medication shipped directly to you."
  },
  {
    "q": "Do you serve other Northern Colorado communities?",
    "a": "Yes \u2014 we serve all of Northern Colorado including Fort Collins, Greeley, Berthoud, and Windsor. Any Colorado resident can schedule a telehealth appointment."
  },
  {
...
export default function LocationLovelandCO() {
    ...
    "@graph": [
      {
        ...
        name: "MedMethod Direct — Loveland, CO",
        url: "https://www.medmethoddirect.com/loveland-co",
        description: "Board-certified telehealth menopause and hormone therapy for women in Loveland, Colorado.",
        areaServed: { "@type": "City", name: "Loveland", containedInPlace: { "@type": "State", name: "Colorado" } },
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Loveland", item: "https://www.medmethoddirect.com/loveland-co" }
        ]
      }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        <title>Menopause Doctor Loveland CO | Hormone Therapy | MedMethod Direct</title>
        <meta name="description" content="Board-certified menopause and hormone therapy for women in Loveland, CO. Specialist-level HRT and GLP-1 weight loss via telehealth — no drive to Fort Collins or Denver." />
        <link rel="canonical" href="https://www.medmethoddirect.com/loveland-co" />
        <meta property="og:title" content="Menopause Doctor Loveland CO | MedMethod Direct" />
        <meta property="og:description" content="Board-certified menopause and hormone therapy for women in Loveland, CO. Specialist-level HRT and GLP-1 weight loss via telehealth — no drive to Fort Collins or Denver." />
        <meta property="og:url" content="https://www.medmethoddirect.com/loveland-co" />
      ...
      <nav className="bg-stone-50 border-b border-stone-200 py-3 px-4 text-sm text-stone-500">
        <div className="max-w-5xl mx-auto flex gap-2">
          ...
          <span>/</span>
          <span className="text-stone-800 font-medium">Loveland</span>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 lg:py-16">
            ...
            <div>
              <nav className="flex items-center gap-2 text-xs font-semibold mb-5" style={{ color: "#aaa", fontFamily: "Montserrat, sans-serif" }}>
                ...
                <span>/</span>
                <span style={{ color: "#333" }}>Loveland</span>
              </nav>
              <div
              ...
              >
                The only virtual clinic combining physician-prescribed hormone therapy, GLP-1 medical weight loss, and menopause care — all in one program, for women in Loveland, CO.
              </p>
              ...
              >
                <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 16 16" fill="none">
                  <circle cx="8" cy="8" r="8" fill="url(#vcGradLoveland)"/>
                  <path d="M4.5 8.5l2.5 2.5 4.5-5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <defs><linearGradient id="vcGradLoveland" x1="0" y1="0" x2="16" y2="16" gradientUnits="userSpaceOnUse"><stop stopColor="#E8339E"/><stop offset="1" stopColor="#7A1E7E"/></linearGradient></defs>
                </svg>
            ...
            <div className="relative lg:-ml-6">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ aspectRatio: "4/3" }}>
                <img
                  src="https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/co-t2-loveland_f8b44784.png"
                  alt="Virtual menopause doctor and hormone therapy for women in Loveland, CO — MedMethod Direct"
                ...
                >
                  <p className="text-white font-bold text-sm tracking-wide" style={{ fontFamily: "Montserrat, sans-serif" }}>
                    Serving Loveland · Fort Collins · Windsor · Greeley
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-4 text-base leading-relaxed" style={{ color: "#444" }}>
            ...
            <p>
              ...
              <strong>perimenopause weight gain</strong>, brain fog, night sweats, low libido, or you've tried GLP-1s elsewhere and hit a plateau — the missing piece is almost always hormonal. MedMethod Direct is one of the only virtual practices in Colorado that addresses <strong>weight loss and hormone balance together</strong>, in a single physician-led program. No driving to Fort Collins or Greeley. No waiting rooms. Just one team, one plan, and results that last.
            </p>
          </div>
        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: <MapPin className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Lab Work Near Loveland", desc: "We order your labs to a convenient LabCorp or Quest draw site near Loveland. Results reviewed within 48 hours." },
              { icon: <Package className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Medications Delivered to Your Door", desc: "Semaglutide, tirzepatide, BHRT, testosterone — shipped directly to your Loveland address, discreetly and on schedule." },
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { stars: 5, quote: 'I\'d tried three different telehealth weight loss companies and none of them worked long-term. The difference with MedMethod is they don\'t just hand you a prescription — they build a system around you. My performance coach holds me accountable every single week. She knows when I\'m traveling, when I\'m stressed, when I need a pep talk. That human element is everything.', name: "Jessica T.", loc: "Loveland, CO" },
              { stars: 5, quote: 'I\'m 55 and I\'d accepted that feeling terrible was just my new normal. Hot flashes at altitude are a special kind of misery. MedMethod put me on a comprehensive HRT protocol and within six weeks the flashes stopped, my sleep came back, and I lost 18 lbs. My husband said it\'s like I came back from somewhere. He\'s not wrong.', name: "Linda G.", loc: "Colorado Area" },
              { stars: 5, quote: 'I\'m an avid hiker and skier and I was terrified that menopause was going to sideline me. My recovery was terrible, my energy was gone by noon, and I\'d gained 20 lbs despite being active every day. MedMethod optimized my hormones and added a GLP-1 — within three months I was back on 14ers and my body felt like mine again. Colorado women don\'t slow down, and neither should our healthcare.', name: "Kimberly H.", loc: "Colorado" },
            ].map((t, i) => (
