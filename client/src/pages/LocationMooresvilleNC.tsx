        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              { quote: "The accountability from my wellness advisor literally saved my program. Month three I was ready to quit — the scale wasn't moving, I was frustrated, and I started skipping my meds. She called me, walked me through why plateaus happen, adjusted my protocol with the doctor, and two weeks later the weight started dropping again. I would have given up without that support.", name: "Crystal B.", location: "North Carolina Area", rating: 5 },
