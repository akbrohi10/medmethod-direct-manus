...
export default function LocationMooresvilleNC() {
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 lg:py-16">
            ...
            <div>
              <nav className="flex items-center gap-2 text-xs font-semibold mb-5" style={{ color: "#aaa", fontFamily: "Montserrat, sans-serif" }}>
                ...
                <span>/</span>
                <span style={{ color: "#333" }}>Mooresville</span>
              </nav>
              <div
              ...
              >
                ...
                <br />
                for Mooresville women
              </h1>
              <p
                className="text-base mb-6 leading-relaxed"
                style={{ fontFamily: "Montserrat, sans-serif", color: "#555", maxWidth: "480px" }}
              >
                The only virtual clinic combining physician-prescribed hormone therapy, GLP-1 medical weight loss, and menopause care — all in one program, for women in Mooresville, NC.
              </p>
              ...
              >
                <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 16 16" fill="none">
                  <circle cx="8" cy="8" r="8" fill="url(#vcGradMooresville)"/>
                  <path d="M4.5 8.5l2.5 2.5 4.5-5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <defs><linearGradient id="vcGradMooresville" x1="0" y1="0" x2="16" y2="16" gradientUnits="userSpaceOnUse"><stop stopColor="#E8339E"/><stop offset="1" stopColor="#7A1E7E"/></linearGradient></defs>
                </svg>
            ...
            <div className="relative lg:-ml-6">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ aspectRatio: "4/3" }}>
                <img
                  ...
                  alt="Virtual menopause doctor and hormone therapy for women in Mooresville, NC — MedMethod Direct"
                ...
                >
                  <p className="text-white font-bold text-sm tracking-wide" style={{ fontFamily: "Montserrat, sans-serif" }}>
                    Serving Mooresville · Cornelius · Davidson · Huntersville
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 px-6" style={{ background: "#F4F4F8" }}>
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4 text-base leading-relaxed" style={{ color: "#444" }}>
            ...
            <p>
              Whether you are experiencing <strong>perimenopause weight gain</strong>, brain fog, night sweats, low libido, or you have tried GLP-1s elsewhere and hit a plateau, the missing piece is almost always hormonal. MedMethod Direct is one of the only virtual practices in North Carolina that addresses <strong>weight loss and hormone balance together</strong>, in a single physician-led program. Women in Mooresville no longer need to drive to Charlotte or Statesville for specialist care.
            </p>
          </div>
      ...
      {/* ── WHY MOORESVILLE WOMEN CHOOSE US ── */}
        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="font-black text-[#111111]" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.2rem)", letterSpacing: "-0.02em" }}>
              Built for Busy Iredell County Women
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: <MapPin className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Lab Work Near Mooresville", desc: "We order your labs to a convenient LabCorp or Quest draw site near Mooresville. Results reviewed within 48 hours." },
              { icon: <Package className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Medications Delivered to Your Door", desc: "Semaglutide, tirzepatide, BHRT, testosterone — shipped directly to your Mooresville address, discreetly and on schedule." },
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { quote: "I gained 45 pounds in two years and my confidence was destroyed. I stopped going to the pool, stopped wearing anything sleeveless, stopped wanting to be in photos with my grandkids. MedMethod's combined approach — hormones plus GLP-1 plus nutrition coaching — has taken 32 lbs off in 5 months. I bought a swimsuit last week for the first time in three years.", name: "Donna C.", location: "Mooresville, NC", rating: 5 },
              { quote: "The accountability from my performance coach literally saved my program. Month three I was ready to quit — the scale wasn't moving, I was frustrated, and I started skipping my meds. She called me, walked me through why plateaus happen, adjusted my protocol with the doctor, and two weeks later the weight started dropping again. I would have given up without that support.", name: "Crystal B.", location: "North Carolina Area", rating: 5 },
              { quote: "I'm a yoga instructor and I thought I was doing everything right — clean eating, daily movement, meditation. But perimenopause doesn't care about your lifestyle. The weight crept on, my sleep fell apart, and my mood was all over the place. MedMethod optimized what my body couldn't do on its own anymore. Hormones aren't a failure — they're a tool. I wish more women understood that.", name: "Brooke A.", location: "North Carolina Patient", rating: 5 },
].map((t) => (
        ...
        <div className="max-w-[900px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-10">
            ...
            <h2 className="font-black leading-tight" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.4rem)", color: "#111111" }}>
              Frequently Asked Questions for{" "}<span style={{backgroundImage: "linear-gradient(135deg, #E8339E 0%, #7A1E7E 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent"}}>Mooresville Patients</span>
            </h2>
          </div>
          {/* Tab buttons */}
