        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            ...
            >
              ...
              <span style={{...gradientText}}>Near Naples?</span>
              <br />
            ...
            <table className="w-full text-sm" style={{ fontFamily: "Montserrat, sans-serif" }}>
              <thead>
                <tr style={{ background: "linear-gradient(135deg, #E8339E 0%, #7A1E7E 100%)" }}>
                  ...
                  <th className="px-6 py-4 text-white font-bold text-xs tracking-wider uppercase text-center">Local OB/GYN in Naples</th>
              ...
              <tbody>
                {[
                  ...
                  { factor: "Commute required", local: "Yes — US-41 / Tamiami Trail traffic", mmd: "None — 100% virtual", mmdWin: true },
                  { factor: "Dedicated wellness advisor", local: "No", mmd: "Yes — between every visit", mmdWin: true },
                  { factor: "Lab work", local: "In-office only", mmd: "Local LabCorp/Quest near Naples", mmdWin: true },
          ...
          >
            ...
            <p className="text-sm text-center mt-3 mb-6" style={{ fontFamily: "Montserrat, sans-serif", color: "#666" }}>
              Women in Naples, Marco Island, and Bonita Springs are discovering that the best care isn't always the closest — it's the most attentive, the most specialized, and the most convenient for your actual life.
            </p>
