...
const faqs = [
  ...
  },
  {
    ...
    a: "We are a direct-care practice and do not bill insurance. This allows same-week availability, 30–60 minute appointments, and care not limited by insurance coverage. Many patients use HSA or FSA funds. We provide itemized receipts for potential out-of-network reimbursement.",
  },
  {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[92vh] flex items-center overflow-hidden bg-[#0D0D1A]">
        ...
        <div
          ...
          style={{ backgroundImage: "url('https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=1600&q=80')" }}
          aria-hidden="true"
        />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="text-[#E8339E] text-xs font-bold tracking-[0.2em] uppercase" style={{ fontFamily: "Montserrat, sans-serif" }}>
              ...
              <h1
                ...
                style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(2.4rem, 5vw, 3.8rem)", letterSpacing: "-0.02em" }}
              >
                VIRTUAL HORMONE,{" "}
              ...
              <p className="text-white/70 text-lg leading-relaxed mb-8 max-w-lg" style={{ fontFamily: "Montserrat, sans-serif" }}>
                The only virtual clinic serving Fairfax County that combines hormone therapy, GLP-1 medical weight loss, and menopause care in one physician-led program. No Tysons traffic. Same-week availability.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 mb-10">
                <button
                  onClick={() => setConsultOpen(true)}
                  className="btn-gradient btn-gradient-pulse px-8 py-4 rounded-full text-sm font-bold tracking-wider"
              ...
              {stats.map((s) => (
                <div key={s.label} className="rounded-2xl p-6 border border-white/10" style={{ background: "rgba(255,255,255,0.04)" }}>
                  <div
                    ...
                    style={{ fontFamily: "Montserrat, sans-serif", fontSize: "2.4rem", background: "linear-gradient(135deg, #E8339E 0%, #C026D3 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}
                  >
                    {s.value}
                  </div>
                  <div className="text-white/50 text-xs font-semibold tracking-widest uppercase" style={{ fontFamily: "Montserrat, sans-serif" }}>
                    {s.label}
                  </div>
                </div>
              ))}
