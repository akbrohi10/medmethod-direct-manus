        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            ...
            >
              ...
              <span style={{...gradientText}}>Near Boca Raton?</span>
              <br />
            ...
            <table className="w-full text-sm" style={{ fontFamily: "Montserrat, sans-serif" }}>
              <thead>
                <tr style={{ background: "linear-gradient(135deg, #E8339E 0%, #7A1E7E 100%)" }}>
                  ...
                  <th className="px-6 py-4 text-white font-bold text-xs tracking-wider uppercase text-center">Local OB/GYN in Boca Raton</th>
              ...
              <tbody>
                {[
                  ...
                  { factor: "Commute required", local: "Yes — Glades Rd / I-95 traffic", mmd: "None — 100% virtual", mmdWin: true },
                  { factor: "Dedicated wellness advisor", local: "No", mmd: "Yes — between every visit", mmdWin: true },
                  { factor: "Lab work", local: "In-office only", mmd: "Local LabCorp/Quest near Boca Raton", mmdWin: true },
          ...
          >
            ...
            <p className="text-sm text-center mt-3 mb-6" style={{ fontFamily: "Montserrat, sans-serif", color: "#666" }}>
              Women in Boca Raton, Delray Beach, and Boynton Beach are discovering that the best care isn't always the closest — it's the most attentive, the most specialized, and the most convenient for your actual life.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[800px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="font-black leading-tight" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.4rem)", color: "#111111" }}>
              Frequently asked questions for{" "}<span style={gradientText}>Boca Raton patients</span>
            </h2>
          </div>
