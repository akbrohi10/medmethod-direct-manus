/* =============================================================================
   Boca Raton, Florida Location Page — MedMethod Direct
   Primary keyword: menopause doctor Boca Raton FL telehealth
   Secondary: hormone therapy Boca Raton Florida, GLP-1 weight loss Boca Raton,
   semaglutide Boca Raton telehealth, virtual menopause care Boca Raton,
   bioidentical hormone therapy Boca Raton, perimenopause treatment Boca Raton FL
   ============================================================================= */
...
const HERO_IMAGE = "https://d2xsxph8kpxj0f.cloudfront.net/310519663416709267/KyWCLydSK7KZUFLqfZ7cfe/florida-boca-hero-kEmxydxB9aBuoULMYjqa8S.webp";
...
const JSONLD_MEDICAL_BUSINESS = {
  ...
  "name": "MedMethod Direct — Boca Raton, Florida",
  "description": "Virtual hormone therapy, medical weight loss, and menopause clinic serving women in Boca Raton, Florida. Physician-prescribed GLP-1 weight loss (semaglutide, tirzepatide), HRT, BHRT, testosterone therapy, perimenopause management, and longevity medicine — 100% virtual, licensed in Florida.",
  "url": "https://medmethoddirect.com/florida/boca-raton",
  "telephone": "",
  "hasMap": "https://medmethoddirect.com/florida/boca-raton",
  "priceRange": "$$",
  ...
  "areaServed": [
    ...
    { "@type": "City", "name": "Palm Beach", "containedInPlace": { "@type": "State", "name": "Florida" } },
  ],
...
const JSONLD_FAQ = {
  ...
  "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "Do you serve patients in Boca Raton, Florida?", "acceptedAnswer": { "@type": "Answer", "text": "Yes — MedMethod Direct is fully licensed to serve patients throughout Boca Raton and Palm Beach County, including Delray Beach, Boynton Beach, Deerfield Beach, and Palm Beach. All care is delivered 100% virtually, so you never need to leave Boca Raton." } },
    { "@type": "Question", "name": "Can I get semaglutide or tirzepatide online in Boca Raton?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. We offer access to both FDA-approved GLP-1 medications and compounded semaglutide and tirzepatide from an FDA-registered 503B outsourcing pharmacy, prescribed by Dr. Al-Deek after a thorough review of your labs and health history. Medications are shipped directly to your Boca Raton address." } },
    { "@type": "Question", "name": "Why choose virtual care over a local OB/GYN in Boca Raton?", "acceptedAnswer": { "@type": "Answer", "text": "Most local practices in Boca Raton have 3–6 week wait times for new patients, and appointments are often limited to 10–15 minutes. With MedMethod Direct, you can be seen within days, your appointments are 30–60 minutes, and you have a dedicated performance coach between visits." } },
  ],
};
...
const testimonials = [
  ...
  { quote: "I\'d been bouncing between weight loss clinics for two years — Semaglutide here, B12 shots there, none of them looking at the whole picture. MedMethod was the first practice that said \'your weight and your hormones are the same problem.\' That one insight changed everything. Down 31 lbs and my performance coach keeps me accountable even when I want to cheat on vacation.", name: "Jennifer S.", location: "Florida" },
];
...
export default function LocationBocaRaton() {
  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: "Montserrat, sans-serif" }}>
      <Helmet>
        <title>Virtual Hormone, Menopause & Weight Loss Doctor in Boca Raton, FL | MedMethod Direct</title>
        <meta name="description" content="Expert virtual hormone therapy, GLP-1 medical weight loss & menopause care for women in Boca Raton, FL. Physician-prescribed semaglutide, BHRT & testosterone. See a doctor this week — free consultation." />
        <link rel="canonical" href="https://medmethoddirect.com/florida/boca-raton" />
        <meta property="og:title" content="Virtual Hormone, Menopause & Weight Loss Doctor in Boca Raton, FL | MedMethod Direct" />
        <meta property="og:url" content="https://medmethoddirect.com/florida/boca-raton" />
        <meta property="og:image" content={HERO_IMAGE} />
        <meta property="og:description" content="Expert virtual hormone therapy, GLP-1 medical weight loss & menopause care for women in Boca Raton, FL. Physician-prescribed semaglutide, BHRT & testosterone. Free consultation." />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Virtual Hormone, Menopause & Weight Loss Doctor in Boca Raton, FL | MedMethod Direct" />
        <meta name="twitter:description" content="Expert virtual hormone therapy, GLP-1 medical weight loss & menopause care for women in Boca Raton, FL. Physician-prescribed semaglutide, BHRT & testosterone. Free consultation." />
        ...
        <script type="application/ld+json">{JSON.stringify(JSONLD_FAQ)}</script>
          ...
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "MedicalWebPage",
            "name": "Virtual Hormone, Menopause & Weight Loss Doctor in Boca Raton, FL",
            "url": "https://medmethoddirect.com/florida/boca-raton",
  "telephone": "",
  "hasMap": "https://medmethoddirect.com/florida/boca-raton",
            "description": "MedMethod Direct provides physician-led virtual hormone therapy, GLP-1 medical weight loss (semaglutide, tirzepatide), menopause management, BHRT, and testosterone therapy for women in Boca Raton, Florida.",
            "about": [
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
              <div>
                ...
                <p className="flex items-center gap-2 font-semibold mb-8" style={{ fontFamily: "Montserrat, sans-serif", color: "#7A1E7E", fontSize: "1rem" }}>
                  <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 16 16" fill="none">
                    <circle cx="8" cy="8" r="8" fill="url(#vcGradBOCA)"/>
                    <path d="M4.5 8.5l2.5 2.5 4.5-5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    <defs><linearGradient id="vcGradBOCA" x1="0" y1="0" x2="16" y2="16" gradientUnits="userSpaceOnUse"><stop stopColor="#E8339E"/><stop offset="1" stopColor="#7A1E7E"/></linearGradient></defs>
                  </svg>
              ...
              <div className="relative lg:-ml-6">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ aspectRatio: "4/3" }}>
                  <img src={HERO_IMAGE} alt="Virtual menopause and hormone therapy doctor for women in Boca Raton, Florida — MedMethod Direct" className="w-full h-full object-cover" width="640" height="480" loading="eager" />
                </div>
                <div className="absolute -bottom-4 -left-4 rounded-2xl px-5 py-3 shadow-xl" style={{ background: "linear-gradient(135deg, #E8339E 0%, #7A1E7E 100%)" }}>
                  ...
                  <p className="text-white/80 text-xs mt-0.5" style={{ fontFamily: "Montserrat, sans-serif" }}>Serving Boca Raton · Delray Beach · Palm Beach</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-[900px] mx-auto px-4 lg:px-8">
          <p className="text-xs font-bold tracking-widest uppercase mb-3" style={{ color: "#E8339E", fontFamily: "Montserrat, sans-serif" }}>Virtual Care for Boca Raton Women</p>
          <h2 className="font-black leading-tight mb-6" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.4rem)", color: "#111111" }}>
            Boca Raton's premier virtual clinic for{" "}<span style={gradientText}>hormones, menopause & weight loss</span>
          </h2>
          <div className="space-y-4 text-base leading-relaxed" style={{ fontFamily: "Montserrat, sans-serif", color: "#444" }}>
            <p>
              If you live in Boca Raton and you've been searching for a <strong>menopause doctor near Boca Raton, FL</strong> or a <strong>medical weight loss physician serving Boca Raton</strong>, you've found the right place.
            </p>
            <p>
              MedMethod Direct is now accepting patients in Boca Raton and throughout Palm Beach County — from Delray Beach and Boynton Beach to Palm Beach and Deerfield Beach. Our physician-led virtual clinic brings expert <strong>perimenopause and menopause management</strong>, <strong>hormone replacement therapy (HRT)</strong>, <strong>bioidentical hormone therapy</strong>, <strong>testosterone optimization for women</strong>, GLP-1 medications including <strong>compounded semaglutide and tirzepatide</strong>, insulin resistance, thyroid optimization, and longevity-focused care directly to you.
            </p>
            <p>
              Boca Raton has a highly health-conscious population, yet specialized menopause and hormone care can still be surprisingly hard to access. Most practices are overbooked and insurance-driven. MedMethod Direct is different: a direct-care model where Dr. Jumana Al-Deek, DO, personally reviews your case, orders and interprets your labs, and builds a protocol specific to you — not a generic template.
            </p>
          </div>
...
{/* WHY BOCA WOMEN CHOOSE US */}
        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="font-black leading-tight" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.6rem)", color: "#111111" }}>
              Why Boca Raton women choose{" "}<span style={gradientText}>MedMethod Direct</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: <Clock className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "No more 6-week waits", body: "Boca Raton's top practices are booked out for months. We can see you this week — from your home, your community, or anywhere in Palm Beach County." },
              ...
              { icon: <MapPin className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "Lab work near you in Boca", body: "We order your labs to a convenient LabCorp or Quest Diagnostics draw site near you in Boca Raton or Palm Beach County. Results reviewed within 48 hours." },
              { icon: <ArrowRight className="w-6 h-6" style={{ color: "#E8339E" }} />, title: "GLP-1s + hormones delivered to your door", body: "Semaglutide, tirzepatide, BHRT, testosterone — shipped directly to your Boca Raton address, discreetly and on schedule." },
            ].map((card) => (
        ...
        <div className="max-w-[1100px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="font-black leading-tight" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.4rem)", color: "#111111" }}>
              What women in{" "}<span style={gradientText}>Boca Raton are saying</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((t) => (
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[900px] mx-auto px-4 lg:px-8">
          <div className="text-center mb-10">
            ...
            <h2 className="font-black leading-tight" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "clamp(1.6rem, 3vw, 2.4rem)", color: "#111111" }}>
              Frequently Asked Questions for{" "}<span style={{backgroundImage: "linear-gradient(135deg, #E8339E 0%, #7A1E7E 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent"}}>Boca Raton Patients</span>
            </h2>
          </div>
          {/* Tab buttons */}
      ...
      <section className="py-20" style={{ background: "linear-gradient(135deg, #E8339E 0%, #B040B0 50%, #7A1E7E 100%)" }}>
        <div className="max-w-[700px] mx-auto px-4 text-center">
          <p className="text-xs font-bold tracking-widest uppercase mb-4 text-white/80" style={{ fontFamily: "Montserrat, sans-serif" }}>Boca Raton, Florida</p>
          ...
          <p className="text-white/85 text-base leading-relaxed mb-8 max-w-xl mx-auto" style={{ fontFamily: "Montserrat, sans-serif" }}>
            Boca Raton women deserve more than a rushed appointment and a prescription handed to them on the way out the door. You deserve a physician who knows your name, knows your labs, and is building a plan specifically for you. Your free consultation is 20 minutes and completely obligation-free.
          </p>
      ...
      <section className="py-14 bg-white border-t border-gray-100">
        <div className="max-w-[900px] mx-auto px-4 lg:px-8 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div>
            ...
            <h3 className="font-black text-xl mb-2" style={{ fontFamily: "Montserrat, sans-serif", color: "#0D0D1A", letterSpacing: "-0.02em" }}>Naples, Florida — Gulf Coast Excellence</h3>
            <p className="text-gray-600 text-sm leading-relaxed max-w-xl" style={{ fontFamily: "Montserrat, sans-serif" }}>
              MedMethod Direct serves patients throughout Florida. If you live or work in Naples, Marco Island, or Southwest Florida, you can access the same physician-led hormone therapy and GLP-1 weight loss programs — 100% virtually, from home.
            </p>
          </div>
          <a href="/florida/naples" className="inline-flex items-center gap-2 font-bold text-sm tracking-wider rounded-full px-7 py-3 whitespace-nowrap transition-all hover:shadow-lg flex-shrink-0" style={{ fontFamily: "Montserrat, sans-serif", background: "linear-gradient(135deg, #E8339E 0%, #7A1E7E 100%)", color: "#fff" }}>
            View Naples Service Area <ArrowRight className="w-4 h-4" />
          </a>
        </div>
      </section>
