/* =============================================================================
   Home1 Page — MedMethod Direct (Dr. AL-Deek Landing Page Duplicate)
   ...
   Sections (cold-traffic ad landing page):
     Navbar → MedicalTeam (Dr. Al-Deek hero) → HowItWorks
            → PopularPrograms → YourMedication → Testimonials → FAQ → Footer
   ============================================================================= */
...
export default function Home1() {
  ...
  return (
    <div className="min-h-screen" style={{ fontFamily: "Montserrat, sans-serif" }}>
      ...
      {/* ── Cold-traffic ad landing page section order (8 sections) ────────── */}
