...
export default function Home1() {
  ...
  const JSONLD_FAQ = {
    ...
    "mainEntity": [
      ...
      { "@type": "Question", "name": "Do I have to buy medication to have a membership?", "acceptedAnswer": { "@type": "Answer", "text": "No. Your membership covers your clinical oversight whether or not you fill a prescription in a given month. Most patients pair a membership with at least one medication, but the structures are independent." } },
      ...
      { "@type": "Question", "name": "Are there hidden fees?", "acceptedAnswer": { "@type": "Answer", "text": "No. Your total at checkout is your membership plus any medications you select. All of our pricing is listed transparently on our website, so you always know exactly what you are paying for before you enroll. Any labs beyond what your tier includes are quoted before you commit." } },
      ...
      { "@type": "Question", "name": "How does my medication ship?", "acceptedAnswer": { "@type": "Answer", "text": "Compounded medications ship directly from our partner pharmacies to your door; brand-name prescriptions ship from the manufacturers' direct programs. Refills are coordinated through your dashboard so you're not managing it manually." } },
      { "@type": "Question", "name": "What's the cancellation and refund policy?", "acceptedAnswer": { "@type": "Answer", "text": "You can cancel your subscription at any time, and it will stop renewing going forward — you're never locked into another term. All sales are final, however: subscription and medication charges are final at the time they're made, and we don't issue refunds for any period already billed." } }
    ]
  };
