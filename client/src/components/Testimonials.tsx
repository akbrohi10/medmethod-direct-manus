...
const testimonials = [
  ...
  },
  {
    ...
    age: "Age 47",
    stars: 5,
    text: "The night sweats and insomnia were ruining my life. I'd wake up drenched at 2 AM and couldn't fall back asleep. My regular doctor kept saying my labs were 'normal.' MedMethod found my progesterone was almost nonexistent and paired GLP-1 with hormone therapy to address both the weight and the symptoms. Within 6 weeks I was sleeping through the night for the first time in two years. I've also lost 31 lbs and my energy is completely back.",
    treatment: "GLP-1 + Hormone Therapy",
    lost: "31 lbs",
    duration: "4 months",
  ...
  },
  {
    ...
    age: "Age 53",
    stars: 5,
    text: "Hot flashes every hour, 40 lbs I couldn't lose, and a doctor who kept telling me it was 'just menopause — you'll get through it.' MedMethod actually listened. They tested my thyroid, cortisol, estrogen, progesterone — everything. They added GLP-1 to my protocol and the weight finally started moving. I sleep, I think clearly, and I've lost 38 lbs in 5 months.",
    treatment: "GLP-1 + Menopause Care",
    lost: "38 lbs",
    duration: "5 months",
