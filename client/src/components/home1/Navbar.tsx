    ...
    >
      <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
        ...
        className="px-3 py-2 text-gray-600 hover:text-[#E8339E] font-medium text-[13px] tracking-wide transition-colors duration-200 whitespace-nowrap"
            ...
            {/* Licensed in 9 States — display only (no link) */}
            <span
              className="flex items-center gap-1.5 px-4 py-2 text-gray-500 font-semibold text-sm tracking-wide"
              style={{ fontFamily: "Montserrat, sans-serif", letterSpacing: "0.05em" }}
            >
      ...
      {mobileOpen && (
        <div className="lg:hidden bg-white border-t border-gray-100">
          <div className="px-4 py-4 flex flex-col gap-1">
            ...
            <span
              className="py-3 font-semibold text-sm tracking-wide border-b border-gray-100 flex items-center gap-1.5"
