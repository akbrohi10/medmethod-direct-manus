...
const steps: Step[] = [
  {
    ...
    description:
      "A 15-minute call to map your goals — before you commit to anything.",
  },
  {
    step: "02",
    title: "Labs + 60-Minute Doctor Visit",
    description:
      "Comprehensive labs, then a deep strategy session with your physician — not a 5-minute check-in.",
  },
  {
    step: "03",
