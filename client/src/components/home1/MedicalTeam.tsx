...
const DR_ALDEEK_SQUARE =
  "/manus-storage/dr-aldeek-portrait-v2_036d1cb9.jpg";
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-12 items-stretch">
            ...
            <div className="order-1 lg:order-2 lg:col-span-7 p-6 md:p-10 lg:p-14 flex flex-col">
              ...
              <p
                className="mt-4 text-[#444] text-base md:text-lg"
                style={{ fontFamily: "Montserrat, sans-serif" }}
              >
              ...
              <div className="mt-6 flex flex-col sm:flex-row sm:items-center gap-4">
                ...
                <div className="flex flex-col gap-2">
                  {/* Microcopy: explains the $20 hold + 15-min framing
                  ...
                  <p
                    ...
                    style={{ fontFamily: "Montserrat, sans-serif" }}
                  >
                    <span className="font-semibold text-[#7A1E7E]">15 min with Dr. Al-Deek</span>
                    {" \u00b7 "}
                    <span>$20 reserves your slot, credited toward your plan</span>
                  </p>
                  <ul
              ...
              <div
                className="mt-7 text-[#333] text-[16px] md:text-[17px] leading-[1.65]"
                style={{ fontFamily: "Montserrat, sans-serif" }}
              >
                ...
                {BIO_SECTIONS.slice(0, 2).map((section, i) => {
                  return (
                    ...
                    >
                      <h4
                        className="text-[13px] tracking-[0.2em] uppercase font-bold mb-2.5"
                        style={{
                          fontFamily: "Montserrat, sans-serif",
                          color: "#B8336A",
                        }}
                  ...
                  {BIO_SECTIONS.slice(2).map((section, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <span
                            className="text-[14px] tracking-[0.18em] uppercase font-bold transition-colors"
                            style={{
                              fontFamily:
