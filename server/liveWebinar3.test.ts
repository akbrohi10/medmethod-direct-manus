...
describe("live webinar 3 A/B variation", () => {
  ...
  it("uses the approved short-form conversion path while retaining the event, video, CTA, and footer essentials", () => {
    ...
    expect(liveWebinar3Source).toContain('landingPage="live-webinar3"');
    ...
    expect(liveWebinar3Source.indexOf("data-webinar3-primary-cta")).toBeLessThan(
      liveWebinar3Source.indexOf("data-webinar3-patient-volume-proof"),
    );
    expect(liveWebinar3Source.indexOf("data-webinar3-patient-volume-proof")).toBeLessThan(
      liveWebinar3Source.indexOf("data-webinar2-primary-cta"),
    );
    expect(liveWebinar3Source.indexOf("data-webinar3-primary-cta")).toBeLessThan(
